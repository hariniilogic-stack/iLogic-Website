(function() {
  ...
  function homeFaqSection() {
    const faqs = [
      ["What services does iLogic Tech provide?", "iLogic Tech offers end-to-end technology solutions including POS systems, cloud ERP, CRM and CMS platforms, software and web/mobile app development, networking, cybersecurity, and CCTV surveillance."],
      ["Which countries does iLogic Tech operate in?", "iLogic Tech is headquartered in Singapore with an active presence across India, Kuwait, and Ireland, serving retail, hospitality, healthcare, and logistics businesses."],
      ["Do you offer LanguageCert or exam certification services?", "Yes. iLogic Tech is an authorized LanguageCert exam center and an official partner for CELPIP (Prometric) and BeingCert, offering English proficiency and international certification exams."],
      ["Does iLogic Tech offer internship programs?", "Yes, we run industry-focused internship training programs that give candidates hands-on experience through real-time projects in software development, AI, and IT systems."],
      ["Can iLogic Tech customize a POS or ERP system for my business?", "Absolutely. We build customized platforms tailored to your business operations, with on-site or remote implementation and ongoing technical support."],
      ["How can I get in touch with iLogic Tech?", "You can reach us at +65 90175062 (Singapore) or +91 72000 05541 (India), email info@ilogic.com.sg, or use the contact form on this website."]
    ];
    return '<section class="section section-muted" id="faq"><div class="container">' +
      sectionHeader("FAQ", "Frequently Asked Questions", "Quick answers to common questions about our products, services, and programs.") +
      '<div class="solution-faq-list">' + faqs.map(item => '<article class="glass detail-card reveal solution-faq-card"><h3>' + item[0] + '</h3><p class="muted">' + item[1] + '</p></article>').join("") + '</div>' +
      '</div></section>';
  }
