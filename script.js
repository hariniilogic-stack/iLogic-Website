(function () {
    ...
    },
    {
      ...
      submenu: [
        ...
        [
          ...
          "exam.html#exam-global-certifications",
        ],
  ...
  const examCategories = [
    [
      "LanguageCert Exams",
      "Global English certification pathways for study, work, and migration goals.",
      "languagecert",
    ],
    [
      "CELPIP Exams",
      "Canadian English proficiency testing support for immigration, professional, and career goals.",
      "celpip",
    ],
    [
      "Academic Partner",
      "Official BeingCert-aligned academic partnership support with guided counselling.",
      "academic",
    ],
    [
      "Global Certifications",
      "Industry-recognized exam tracks in cloud, networking, security, and administration.",
      "global",
    ],
  ];
  const certificationPrograms = [
    [
      "AWS",
      "Cloud Practitioner, Solutions Architect, Developer, and operations-focused certification tracks.",
    ],
    [
      "Cisco",
      "CCNA, enterprise networking, security, routing, switching, and infrastructure pathways.",
    ],
    [
      "Azure",
      "Microsoft Azure fundamentals, administration, architecture, security, and DevOps certifications.",
    ],
    [
      "CompTIA",
      "A+, Network+, Security+, and core IT certifications for foundational career growth.",
    ],
    [
      "Google Cloud",
      "Cloud engineering, architecture, Kubernetes, data, and modern infrastructure programs.",
    ],
    [
      "Red Hat",
      "Linux administration, RHCSA, RHCE, automation, and enterprise platform credentials.",
    ],
  ];
  const examDomainDetails = {
    languagecert: {
      ...
      summary:
        "LanguageCert Academic is presented in the PPT as a globally recognized English proficiency pathway for students who need to prove their communication skills for higher education, study-abroad plans, and international academic environments.",
      intro:
        "This dedicated exam page keeps the same iLogic experience while organizing the LanguageCert information from the PPT into a clearer, slightly detailed format. It highlights recognition, exam structure, practical benefits, and the kind of students this pathway is designed for.",
      levels: [
        "Academic-purpose English certification",
        "Four-skill assessment model",
        "Multi-level test structure",
        "Suitable for higher education admission",
        "Designed for real-world academic communication",
      ],
      benefits: [
        "Recognized by universities and institutions in the UK, Australia, New Zealand, Canada, the USA, Ireland, and many other countries worldwide.",
        "Helps students demonstrate the English proficiency needed for admission where English is the language of instruction.",
        "Supports not only assessment but also development of real-world academic English skills.",
        "Strengthens readiness for studying, presenting, writing, reading, and communicating in international academic environments.",
      ],
      extras: [
        "The PPT describes it as a four-skill, multi-level test of English communicative ability for academic purposes.",
        "It is intended for students planning to enter higher education institutions and needing a recognized proof of language proficiency.",
        "The presentation highlights global reach using figures such as 100+ countries, 200+ countries and territories, and 3300+ institutions.",
        "The exam focus is practical communication, not only theory, so learners build language confidence that is useful inside real academic settings.",
      ],
      rounds: [
        [
          "Listening",
          "Measures how effectively a student can understand spoken English in academic and practical communication contexts.",
        ],
        [
          "Reading",
          "Evaluates the ability to understand written English, identify meaning, and work with information from academic-style texts.",
        ],
        [
          "Writing",
          "Assesses how clearly and accurately a candidate can produce structured written English for academic use.",
        ],
        [
          "Speaking",
          "Checks spoken communication ability, fluency, clarity, and confidence in English interaction.",
        ],
        [
          "Academic Readiness Outcome",
          "Together, these four parts are positioned in the PPT as preparation for surviving, thriving, and flourishing in an English-medium academic environment.",
        ],
      ],
      overviewTitle: "LanguageCert Overview",
      overviewIntro:
        "The information below is organized from the PPT into clear sections while keeping your app's design language.",
      roundsTitle: "Exam Structure",
      roundsIntro:
        "The PPT emphasizes a four-skill model, so this page presents those exam components as the core structure of the assessment.",
    ...
    aws: {
      ...
      summary:
        "Structured AWS certification guidance for foundational, associate, and professional-level candidates preparing for cloud operations, architecture, and deployment roles.",
      intro:
        "Our AWS exam support page keeps the same iLogic experience while organizing the exam journey into a dedicated flow for learners who need clarity before they register.",
      levels: [
        "Cloud Practitioner",
        "Solutions Architect",
        "Developer",
        "SysOps Administrator",
        "Security and Specialty tracks",
      ],
      rounds: [
        [
          "Profile Counselling",
          "Discuss your current experience, target role, and the AWS certification path that best fits your background.",
        ],
        [
          "Eligibility and Registration Guidance",
          "Get help with account setup, exam selection, preferred slot planning, and documentation review before booking.",
        ],
        [
          "Preparation and Revision",
          "Receive syllabus-level guidance, preparation priorities, revision checkpoints, and support around key AWS services.",
        ],
        [
          "Mock Assessment Review",
          "Run through practice questions, scenario-based discussion, and last-mile correction before the final exam.",
        ],
        [
          "Final Exam Support",
          "Complete the certification attempt with timing guidance, exam-day readiness tips, and post-exam next-step advice.",
        ],
      ],
      benefits: [
        "Improves visibility for cloud and DevOps roles",
        "Builds confidence in AWS services, architecture, and governance",
        "Supports migration, operations, and solution design careers",
        "Creates a stronger profile for global project opportunities",
      ],
      extras: [
        "Recommended for freshers, cloud engineers, support teams, and solution architects",
        "Useful for organizations standardizing cloud skills across teams",
        "Can be aligned with role-based upskilling and interview preparation",
      ],
    },
    cisco: {
      ...
      summary:
        "Cisco certification support for candidates building careers in networking, enterprise infrastructure, routing, switching, and security operations.",
      intro:
        "This page organizes the Cisco journey separately so candidates can understand the stages, support model, and benefits before they enquire.",
      levels: [
        "CCNA",
        "CCNP Enterprise",
        "Security tracks",
      ...
      rounds: [
        [
          ...
          "Identify whether you should begin with associate-level networking or move into a more specialized Cisco track.",
        ],
        [
          "Exam Planning",
          "Review exam code, syllabus scope, expected knowledge level, and recommended preparation sequence.",
        ],
        [
          "Technical Preparation",
          "Focus on routing, switching, wireless, troubleshooting, and network security concepts relevant to the selected exam.",
        ],
        [
          "Scenario and Lab Review",
          "Practice configuration logic, diagnostic reasoning, and exam-style problem solving.",
        ],
        [
          "Exam Completion and Progression",
          "Finalize the attempt and map the next certification or job role progression step after the result.",
        ],
      ],
      benefits: [
        "Strengthens networking fundamentals and troubleshooting confidence",
        "Supports infrastructure, NOC, and enterprise admin careers",
        "Helps candidates build credibility in routing and switching roles",
        "Improves employability in MSP, telecom, and enterprise environments",
      ],
      extras: [
        "Strong fit for network support engineers and aspiring system administrators",
        "Useful for candidates targeting enterprise infrastructure roles",
        "Can be paired with security or cloud pathways for broader growth",
      ],
    },
    azure: {
      ...
      summary:
        "Azure exam guidance for candidates preparing for administration, cloud operations, architecture, and Microsoft ecosystem roles.",
      intro:
        "The Azure page groups the complete exam flow into a dedicated experience so learners can review rounds, benefits, and support without leaving the app design.",
      levels: [
        "AZ-900 Fundamentals",
        "Administrator",
        "Developer",
      ...
      rounds: [
        [
          "Goal Assessment",
          "Choose the right Azure exam based on prior experience, current job profile, and expected cloud responsibilities.",
        ],
        [
          "Registration Support",
          "Understand the right exam code, scheduling path, and platform steps before booking.",
        ],
        [
          "Preparation Roadmap",
          "Review core Azure services, identity, governance, virtual networking, and cost-management topics.",
        ],
        [
          "Practice and Readiness Check",
          "Validate readiness using mock questions, concept revision, and weak-area tracking.",
        ],
        [
          "Exam and Next Certification Planning",
          "Complete the exam with support around final preparation and identify the next Microsoft pathway after the result.",
        ],
      ],
      benefits: [
        "Builds cloud confidence inside the Microsoft ecosystem",
        "Supports admin, infra, and architect career paths",
        "Improves readiness for enterprise cloud transformation projects",
        "Adds value for hybrid cloud and Windows-based environments",
      ],
      extras: [
        "Recommended for system admins, freshers, and cloud transition candidates",
        "Useful for organizations adopting Microsoft cloud services",
        "Pairs well with security, DevOps, and data-focused learning plans",
      ],
    },
    comptia: {
      ...
      summary:
        "CompTIA exam support for candidates who need a strong base in hardware, networking, security, and entry-level IT problem solving.",
      intro:
        "This dedicated page gives each CompTIA pathway its own structure while preserving your current visual system and exam UI style.",
      levels: [
        "IT Fundamentals",
        "A+",
        "Network+",
        "Security+",
        "Server+ and related tracks",
      ],
      rounds: [
        [
          "Foundation Review",
          "Decide whether you need a beginner-friendly track or a role-specific certification based on your current level.",
        ],
        [
          "Exam Selection and Planning",
          "Review the best-fit CompTIA exam, sequence, and preparation timeline.",
        ],
        [
          "Concept Preparation",
          "Cover the objective domains including devices, networking, operating systems, troubleshooting, and security basics.",
        ],
        [
          "Mock Review and Gap Fixing",
          "Use practice-led revision to identify weak areas and improve exam confidence.",
        ],
        [
          "Certification Attempt",
          "Proceed with the final exam and plan your next step into networking, support, cybersecurity, or systems roles.",
        ],
      ],
      benefits: [
        "Builds a practical entry point into IT and support careers",
        "Improves confidence in troubleshooting and system fundamentals",
        "Creates a stronger base before advanced certifications",
        "Helps freshers present validated technical knowledge to employers",
      ],
      extras: [
        "Best suited for beginners, service desk aspirants, and junior engineers",
        "Commonly used as a first certification before cloud or security specializations",
        "Supports interview preparation for foundational technical roles",
      ],
    },
    "google-cloud": {
      ...
      summary:
        "Google Cloud certification guidance for candidates interested in cloud engineering, data platforms, architecture, and modern infrastructure delivery.",
      intro:
        "This page separates Google Cloud exams into their own destination so users can browse the path, benefits, and enquiry form with the same app theme.",
      levels: [
        "Cloud Digital Leader",
        "Associate Cloud Engineer",
        "Professional Cloud Architect",
        "Data and Security tracks",
      ],
      rounds: [
        [
          "Role Alignment",
          "Map the correct Google Cloud certification to your job goal, cloud experience, and technical depth.",
        ],
        [
          "Scheduling Guidance",
          "Support candidates in understanding exam flow, account setup, and booking preparation.",
        ],
        [
          "Technical Readiness",
          "Cover services related to compute, storage, IAM, networking, Kubernetes, and data workflows.",
        ],
        [
          "Practice Validation",
          "Use review checkpoints and mock discussion to improve readiness before the real test.",
        ],
        [
          "Exam Attempt and Growth Plan",
          "Finish the exam process and decide the next certification or specialization path.",
        ],
      ],
      benefits: [
        "Supports roles in cloud engineering and platform operations",
        "Improves familiarity with modern cloud-native tooling",
        "Adds value for infrastructure, data, and container-focused careers",
        "Demonstrates readiness for scalable cloud environments",
      ],
      extras: [
        "Relevant for engineers working with modern application stacks",
        "Helpful for candidates moving toward DevOps, SRE, or cloud ops roles",
        "Can be aligned with data and analytics learning paths",
      ],
    },
    "red-hat": {
      ...
      summary:
        "Red Hat certification support for learners building expertise in Linux administration, automation, enterprise operations, and platform reliability.",
      intro:
        "The Red Hat page keeps the same design language while giving this exam domain a dedicated structure for rounds, benefits, and enquiry handling.",
      levels: [
        "RHCSA",
        "RHCE",
        "Automation and Ansible tracks",
        "Enterprise platform pathways",
      ],
      rounds: [
        [
          "Track Consultation",
          "Identify whether the candidate should begin with administration fundamentals or move into advanced automation roles.",
        ],
        [
          "Exam and Lab Planning",
          "Review the practical nature of the certification, expected skill depth, and best timeline for preparation.",
        ],
        [
          "Hands-on Preparation",
          "Focus on Linux administration, services, permissions, networking, shell work, and automation workflows.",
        ],
        [
          "Performance Validation",
          "Practice task-based execution and exam-style time management before the final attempt.",
        ],
        [
          "Final Attempt and Advancement",
          "Take the certification with better readiness and plan the next enterprise Linux or automation milestone.",
        ],
      ],
      benefits: [
        "Builds strong Linux administration credibility",
        "Supports infrastructure, DevOps, and platform engineering careers",
        "Improves practical task execution in enterprise environments",
        "Adds value for automation and server management roles",
      ],
      extras: [
        "Strong match for administrators, DevOps learners, and support engineers",
        "Useful in enterprise and data-center aligned environments",
        "Well suited for candidates who prefer practical, hands-on assessments",
      ],
    },
  };
  const examFeedbackSocials = [
    [
      "Instagram",
      "https://www.instagram.com/ilogictech_madurai/?hl=en",
      "instagram",
    ],
  ...
  const internshipJourney = [
    ...
    "2. Assessment: Technical screening and interview.",
    "3. Training: Hands-on project-based learning.",
    "4. Project: Real-world client project work.",
    "5. Certification: Receive your completion certificate.",
    "6. Career: Job placement assistance.",
  ];
  ...
  const products = [
    [
      "ai-pos-scale",
      "AI POS Scale",
      "src/assets/products/product-9.png",
      "Smart weighing with AI-powered POS integration for retail and supermarkets.",
      ["AI recognition", "Auto pricing", "Touch display"],
    ],
    [
      "pos-terminal",
      "POS Terminal",
      "src/assets/products/product-15.png",
      "All-in-one point of sale system for seamless business operations.",
      ["Fast checkout", "Inventory sync", "Multi-payment"],
    ],
    [
      "fnb-pos-kiosk",
      "F&B POS Kiosk",
      "src/assets/products/product-10.png",
      "Self-service kiosk for food and beverage operations with intuitive ordering.",
      ["Self-ordering", "Menu display", "Queue management"],
    ],
    [
      "cash-management",
      "Cash Management System",
      "src/assets/products/product-11.png",
      "Advanced cash management system for secure and efficient handling.",
      ["Bill counting", "Counterfeit detection", "Auto sorting"],
    ],
    [
      "cash-drawer",
      "Cash Drawer",
      "src/assets/products/product-12.png",
      "Durable cash storage solution for retail environments.",
      ["Heavy duty", "Auto open", "Multi-slot"],
    ],
    [
      "barcode-scanner",
      "Barcode Scanner",
      "src/assets/products/product-14.png",
      "High-speed barcode reading for efficient operations.",
      ["1D/2D scan", "Wireless", "Fast decode"],
    ],
    [
      "thermal-printer",
      "Thermal Printer",
      "src/assets/products/product-13.png",
      "High-speed thermal receipt printer for business needs.",
      ["High speed", "Auto cutter", "USB/WiFi"],
    ],
  ];
  const productDetailPoints = {
    "ai-pos-scale": {
      highlights: [
        "AI-based weighing support for modern retail counters",
        "Automatic pricing linked with product weight",
        "Fast touchscreen workflow for staff convenience",
      ...
      overview: [
        ...
        "Responsive touch display for quick cashier interaction",
        "Suitable for retail counters and supermarket environments",
      ],
      benefits: [
        "Fast and accurate weighing performance",
        "Seamless POS integration for billing",
  ...
  const services = [
    [
      ...
      "Enterprise software solutions for business automation, productivity, and digital transformation.",
      [
      ...
      [
        "We craft modern software applications with scalable architecture, resilient engineering practices, and business-focused delivery.",
        "Our solutions are designed for long-term growth, seamless integrations, and high performance across evolving digital environments.",
        "From discovery to deployment, we build systems that accelerate transformation and support measurable business outcomes.",
      ],
    ],
    [
      "web-applications",
      "Web Application",
      "Scalable, high-performance web applications engineered with modern frameworks, cloud-native technologies, and user-centric design to deliver seamless digital experiences and robust business solutions.",
      [
      ...
      [
        "We build web applications with modern frontend experiences, scalable backend systems, and cloud-ready delivery models.",
        "Every solution is optimized for speed, usability, security, and long-term maintainability across business-critical workflows.",
        "Our engineering approach combines user-centric design with robust architecture to deliver dependable digital products.",
      ],
    ],
    [
      "mobile-apps",
      "Mobile Application",
      "High-performance mobile applications built with cutting-edge technologies, delivering seamless user experiences, scalable architectures, and near-native performance across all devices and platforms.",
      [
      ...
      [
        "We develop mobile applications that combine polished user experiences with scalable engineering and high runtime performance.",
        "Our team delivers native and cross-platform solutions tailored for business growth, reliability, and evolving customer expectations.",
        "From architecture to launch, we focus on secure, intelligent, and future-ready mobile ecosystems.",
      ],
    ],
    [
      "ai-ml",
      "AI/ML",
      "Applied artificial intelligence and machine learning solutions that automate decisions, uncover insights, and improve customer experiences with production-ready models.",
      [
      ...
      [
        "We design AI/ML systems that move beyond prototypes into practical business workflows with measurable impact.",
        "Our team supports data preparation, model development, integration, and operationalization for real-world use cases.",
        "Each solution is aligned to accuracy, scalability, governance, and day-to-day usability across business teams.",
      ],
    ],
    [
      "networking",
      "Network Infrastructure & Connectivity",
      "Next-generation networking solutions engineered for high availability, ultra-fast performance, and secure data transmission empowering businesses with scalable, resilient, and future-ready digital connectivity.",
      [
        "Network Design & Planning",
        "Router & Switch Configuration",
        "SDN & Hybrid Infrastructure",
        "Network Monitoring",
      ],
      [
        "We design and implement resilient networking environments built for speed, uptime, scalability, and secure connectivity.",
        "Our infrastructure services cover enterprise routing, switching, hybrid environments, and intelligent monitoring across modern operations.",
        "Each deployment is aligned to performance goals, security standards, and the demands of future-ready digital growth.",
      ],
    ],
    [
      "cybersecurity",
      "Cybersecurity",
      "Comprehensive, intelligence-driven cybersecurity solutions designed to safeguard digital ecosystems, mitigate advanced threats, and ensure resilient, compliant, and secure business operations in an evolving threat landscape.",
      [
        "Threat Detection",
      ...
      [
        "We provide proactive cybersecurity services that help organizations defend infrastructure, users, applications, and sensitive data.",
        "Our strategy blends threat intelligence, prevention, detection, and response to reduce risk across complex digital environments.",
        "We also support compliance, governance, and long-term resilience through structured security programs and continuous assessment.",
      ],
    ],
    [
      "cctv-surveillance",
      "CCTV",
      "Next-generation surveillance solutions combining intelligent video analytics, real-time monitoring, and advanced security integration to deliver proactive threat detection and 24/7 situational awareness.",
      [
      ...
      [
        "We deliver surveillance systems that combine smart camera deployment, remote visibility, and integrated physical security workflows.",
        "Our solutions use intelligent analytics and real-time monitoring to strengthen situational awareness and proactive threat response.",
        "From design to deployment, we build secure, scalable CCTV ecosystems for modern commercial and enterprise environments.",
      ],
    ],
    [
      "internship-program",
      "Internship",
      "Industry-oriented internship experiences that blend mentorship, hands-on delivery, and project-based learning to prepare students for real technology roles.",
      [
      ...
      [
        "We create internship journeys that connect classroom learning to practical product and service delivery environments.",
        "Participants learn by building, collaborating, and presenting work shaped by real business expectations.",
        "The program strengthens confidence, technical skill, communication, and career readiness for entry-level opportunities.",
      ],
    ],
    [
      "language-training",
      "Language Training",
      "Career-focused English language training designed to improve communication, certification readiness, and global employability for students and professionals.",
      [
        "LanguageCert Certification Training",
        "Speaking, Reading, Writing & Listening Skills",
        "Interview & Professional Communication",
        "International Career Support",
      ],
      [
        "We support learners with structured language training built around measurable improvement and certification readiness.",
        "Programs combine communication practice, expert guidance, and progression support for academic and professional goals.",
        "Each batch is designed to improve confidence, clarity, and readiness for international opportunities.",
      ],
    ],
  ];
  const serviceDetails = {
    "software-development": {
      ...
      idealFor:
        "Organizations that need custom platforms, automation tools, customer portals, or internal business applications tailored to their workflow.",
    },
    "web-applications": {
      deliverables: [
        "Responsive web experiences optimized for desktop and mobile",
        "Frontend applications built with modern SPA and PWA patterns",
        "Backend services, APIs, and admin control panels",
        "Performance tuning, security hardening, and analytics setup",
      ],
      process: [
        "Product planning focused on user journeys and core actions",
        "Interface design aligned to brand and usability goals",
        "Full-stack development with modular, testable components",
        "Launch readiness, optimization, and support handover",
      ],
      outcomes: [
        "Fast, consistent experiences across browsers and devices",
        "Improved conversion, usability, and operational efficiency",
        "Reliable performance under growing traffic and usage",
        "A future-ready platform that supports new features easily",
      ],
      idealFor:
        "Businesses launching customer-facing portals, dashboards, booking systems, ecommerce workflows, or internal web tools.",
    },
    "mobile-apps": {
      deliverables: [
        "Native and cross-platform mobile applications",
        "Secure login, notifications, offline-ready flows, and API connectivity",
        "Admin dashboards and backend services for app operations",
        "Store submission support and release management",
      ],
      process: [
        "Requirement mapping for core user journeys and device needs",
        "UX planning for simple, intuitive app interactions",
        "Iterative builds with testing across screen sizes and platforms",
        "Publishing, monitoring, and update planning after launch",
      ],
      outcomes: [
        "Consistent mobile experiences with strong runtime performance",
        "Faster adoption through polished design and smooth navigation",
        "Reliable sync between mobile apps and backend systems",
        "A scalable foundation for future features and integrations",
      ],
      idealFor:
        "Brands building customer apps, field-service tools, staff apps, delivery platforms, booking apps, or mobile extensions of existing systems.",
    },
    "ai-ml": {
      deliverables: [
        "Use-case discovery, data strategy, and model design",
        "Predictive models, recommendation engines, and automation workflows",
        "NLP, chatbot, and computer-vision solution integration",
        "Deployment pipelines, monitoring, and continuous optimization",
      ],
      process: [
        "Identify the highest-value business use cases and available data sources",
        "Prepare datasets, validate quality, and define measurable performance goals",
        "Develop, test, and integrate models into real operational workflows",
        "Monitor outcomes and improve accuracy, speed, and business impact over time",
      ],
      outcomes: [
        "Smarter decision-making with faster access to business insights",
        "Reduced manual effort through automation and intelligent assistance",
        "Improved customer experience via personalization and predictive support",
        "Scalable AI capabilities aligned with governance and production reliability",
      ],
      idealFor:
        "Organizations exploring automation, predictive analytics, intelligent customer support, vision systems, or AI-enabled decision workflows.",
    },
    cybersecurity: {
      deliverables: [
        "Risk assessments, vulnerability scans, and security reviews",
        "Incident response planning and remediation guidance",
        "Endpoint, network, and access-control hardening",
        "Compliance-aligned documentation and security governance support",
      ],
      process: [
        "Assess current infrastructure, applications, and exposure points",
        "Prioritize risks based on business impact and likelihood",
        "Implement controls for prevention, detection, and response",
        "Review continuously with reporting and improvement actions",
      ],
      outcomes: [
        "Reduced attack surface across users, systems, and applications",
        "Faster response to incidents and security events",
        "Stronger compliance posture and internal security discipline",
        "Higher confidence in business continuity and digital resilience",
      ],
      idealFor:
        "Organizations that need practical protection for infrastructure, cloud systems, remote teams, business applications, and regulated operations.",
    },
    networking: {
      deliverables: [
        "Network design for offices, branches, and hybrid environments",
        "Router, switch, VLAN, firewall, and wireless configuration",
        "Monitoring, redundancy, and failover planning",
        "Structured documentation and support for ongoing operations",
      ],
      process: [
        "Assess current connectivity, performance, and growth requirements",
        "Design topology and security policies around business usage",
        "Deploy and test routing, segmentation, and device performance",
        "Monitor, optimize, and support the live environment",
      ],
      outcomes: [
        "Stable connectivity with improved speed and availability",
        "Secure and segmented network access across teams and locations",
        "Reduced downtime through monitoring and redundancy planning",
        "Infrastructure that supports long-term digital growth",
      ],
      idealFor:
        "Retail chains, offices, warehouses, hospitality sites, and growing businesses that depend on dependable, secure connectivity.",
    },
    "cctv-surveillance": {
      deliverables: [
        "Smart CCTV deployment with camera planning and placement",
        "Remote monitoring, storage, and centralized visibility setup",
        "AI-enabled analytics, alerts, and event tracking",
        "Integration with access control and physical security workflows",
      ],
      process: [
        "Survey the site and identify key coverage zones",
        "Plan camera types, storage, and monitoring requirements",
        "Install, configure, and test analytics and access integrations",
        "Train teams and support the system after go-live",
      ],
      outcomes: [
        "Improved visibility across facilities, entrances, and operations",
        "Faster identification of incidents and unusual activity",
        "Better coordination between surveillance and access control",
        "A scalable physical security platform for future expansion",
      ],
      idealFor:
        "Commercial spaces, offices, campuses, retail locations, warehouses, and facilities that need always-on visibility and smarter physical security.",
    },
  };
  const serviceExperienceDetails = {
    "software-development": {
      ...
      heroText:
        "Custom software solutions that streamline business operations and accelerate digital transformation.",
      stats: [
      ...
      capabilities: [
        [
          ...
          "High-performance desktop applications with modern UI and seamless integration.",
          [
        ...
        [
          "Enterprise Software",
          "Scalable enterprise solutions for secure and efficient business operations.",
          [
        ...
        [
          "Database Solutions",
          "Secure and scalable database solutions for high-performance applications.",
          [
            "Database Design",
            "Performance Optimization",
            "Data Migration",
        ...
        [
          "API Development",
          "Secure API solutions for seamless connectivity and system integration.",
          [
            "RESTful APIs",
        ...
        [
          ...
          "Reliable software support, updates, and performance optimization.",
          [
            "Bug Fixes & Updates",
      ...
      stacks: [
        ...
        [
          ...
          ["React", "Angular", "Vue.js", "Node.js", "Spring Boot", "Laravel"],
        ],
        [
          "Databases & Tools",
          ["PostgreSQL", "MongoDB", "Docker", "Kubernetes", "Git", "Redis"],
        ],
      ],
      ...
      journey: [
        [
          "Requirements Analysis",
          "Comprehensive analysis of business requirementsBusiness requirement analysis and solution planning., user needs, and technical specifications.",
        ],
        ["System Design", "Scalable system architecture and database design."],
        [
          "Development",
          "Agile software development using modern technologies.",
        ],
        [
          "Testing & QA",
        ...
        [
          "Deployment",
          "Secure deployment, monitoring, and ongoing technical support.",
        ],
      ],
      ctaTitle: "Build Your Next Software Solution",
      ctaText:
        "Custom software development designed for business growth and innovation.",
    ...
    "web-applications": {
      ...
      heroText:
        "Custom web application development using modern frameworks, secure architecture, and responsive design.",
      stats: [
        ["200", "Web Projects"],
      ...
      capabilities: [
        [
          ...
          "Creating stunning, responsive user interfaces with modern frameworks and cutting-edge design principles.",
          [
            "Responsive Design",
        ...
        [
          ...
          "Developing powerful online stores with secure payment processing and inventory management systems.",
          [
        ...
        [
          "Performance Optimization",
          "Enhancing website speed, SEO, and user experience through advanced optimization techniques.",
          [
            "Core Web Vitals",
            "SEO Optimization",
            "Code Splitting",
      ...
      journey: [
        ...
        [
          ...
          "Building your application with clean, maintainable code and rigorous testing throughout the development cycle.",
        ],
        [
          "04 Deployment & Support",
          "Launching your application with proper monitoring, maintenance, and ongoing support for optimal performance.",
        ],
      ],
    ...
    "mobile-apps": {
      ...
      heroText:
        "Building high-performance iOS, Android, and cross-platform apps for startups, SMEs, and enterprises across Madurai, Pondicherry, Tamil Nadu, and Singapore.",
      stats: [
        ["24/7", "Support"],
      ...
      capabilities: [
        [
          "iOS Development",
          "Native iOS apps using Swift and Objective-C with seamless integration into the Apple ecosystem.",
          [
            "Swift & SwiftUI",
        ...
        [
          "Android Development",
          "High-performance Android applications using Kotlin and Java with Material Design principles.",
          [
            "Kotlin & Java",
            "Material Design",
        ...
        [
          "Cross-Platform",
          "Efficient cross-platform solutions using React Native and Flutter for faster development cycles.",
          [
            "React Native",
            "Flutter Development",
            "Code Reusability",
        ...
        [
          ...
          "Business, commerce, healthcare, education, and social applications built around real user workflows.",
          [
            "E-commerce Apps",
            "Healthcare Apps",
            "Education Apps",
      ...
      journey: [
        [
          "Ideation & Strategy",
          "Market research, competitor analysis, and feature planning to define your app's unique value proposition.",
        ],
        [
          "UI/UX Design",
        ...
        [
          "Development",
          "Building your app with clean, scalable code, implementing features, and integrating third-party services.",
        ],
        [
          "Testing & QA",
          "Comprehensive testing across devices, performance optimization, and quality assurance protocols.",
        ],
        [
          "Launch & Support",
          "App store submission, marketing support, and ongoing maintenance with regular updates.",
        ],
      ],
    ...
    "ai-ml": {
      ...
      heroText:
        "Practical artificial intelligence and machine learning solutions designed to automate workflows, elevate customer experiences, and unlock better business decisions.",
      stats: [
        ["40", "AI Use Cases"],
        ["96", "Model Accuracy"],
        ["24", "Hour Monitoring"],
      ...
      capabilities: [
        [
          "Predictive Analytics",
          "Forecast demand, identify trends, and improve planning with data-driven predictive models.",
          [
            "Demand Forecasting",
            "Risk Scoring",
            "Sales Predictions",
        ...
        [
          ...
          "Automate repetitive tasks and decision workflows using machine learning and business rules.",
          [
            "Workflow Automation",
            "Document Processing",
            "Classification",
        ...
        [
          "Computer Vision",
          "Deploy visual intelligence for monitoring, quality checks, recognition, and operational visibility.",
          [
            "Object Detection",
        ...
        [
          ...
          "Build chatbots, assistants, and language processing systems that improve support and engagement.",
          [
            "Chatbots",
            "Sentiment Analysis",
            "Knowledge Search",
      ...
      stacks: [
        ...
        [
          "Business Focus",
          ["Automation", "Forecasting", "Vision Systems", "Conversational AI"],
        ],
      ],
      ...
      journey: [
        [
          "Discover",
          "Identify high-value use cases, data readiness, and measurable business goals.",
        ],
        [
          "Prepare",
          "Clean, structure, and validate datasets while defining model success criteria.",
        ],
        [
          "Build",
          "Train, test, and refine models using the right algorithms and evaluation methods.",
        ],
        [
          "Deploy",
          "Integrate models into production systems, dashboards, or user-facing workflows.",
        ],
        [
          "Optimize",
          "Monitor outcomes continuously and improve performance, accuracy, and operational fit.",
        ],
      ],
      ctaTitle: "Ready to Put AI to Work?",
      ctaText:
        "Turn your data and workflows into intelligent systems with practical, scalable AI delivery.",
    ...
    cybersecurity: {
      ...
      capabilities: [
        ...
        [
          "Security Monitoring",
          "24/7 security operations center services with real-time threat detection and response.",
          [
            "SIEM Implementation",
      ...
      stacks: [
        ...
        [
          "Protection Areas",
          ["Endpoints", "Applications", "Networks", "Identity"],
        ],
        [
          "Operating Model",
    ...
    networking: {
      ...
      heroText:
        "End-to-end LAN, WAN, wireless, firewall, cloud, and monitoring solutions engineered for scalability, redundancy, and high availability.",
      stats: [
        ["99", "Network Uptime"],
        ["10", "Gbps Capacity"],
        ["500", "Devices Managed"],
      ...
      capabilities: [
        [
          ...
          "Custom network topology design with scalable architecture for optimal performance and future growth.",
          [
        ...
        [
          "Wireless Solutions",
          "Enterprise-grade wireless networks with seamless coverage, high-speed connectivity, and advanced security.",
          [
            "Wi-Fi 6/6E Implementation",
        ...
        [
          "Network Security",
          "Multi-layered security solutions including firewalls, intrusion detection, and access control systems.",
          [
        ...
        [
          "Network Monitoring",
          "24/7 network monitoring with real-time alerts, performance analytics, and proactive maintenance.",
          [
            "Real-time Monitoring",
        ...
        [
          ...
          "High-performance data center networks with redundancy, load balancing, and disaster recovery.",
          [
            "Core Infrastructure",
            "Load Balancing",
            "Redundancy Planning",
        ...
        [
          "Network Maintenance",
          "Comprehensive maintenance services including updates, troubleshooting, and performance optimization.",
          [
            "Regular Updates",
            "Troubleshooting",
            "Performance Tuning",
      ...
      stacks: [
        ...
        [
          "Protocols & Standards",
          ["BGP/OSPF", "IPSec", "802.11ax", "Ethernet"],
        ],
        [
          "Support Coverage",
          ["On-site Support", "Remote Support", "RCA", "Disaster Recovery"],
        ],
      ],
      ...
      journey: [
        [
          "Assess",
          "Evaluate topology, bottlenecks, device health, and expansion needs across the environment.",
        ],
        [
          "Design",
          "Define secure architecture, segmentation, redundancy, and performance targets.",
        ],
        [
          "Deploy",
          "Configure routers, switches, wireless systems, firewalls, and hybrid connectivity.",
        ],
        [
          "Monitor",
          "Track performance, alerts, and uptime with proactive analytics and reporting.",
        ],
        [
          "Optimize",
          "Tune the network continuously for growth, resilience, and business continuity.",
        ],
      ],
      ctaTitle: "Ready to Upgrade Your Network?",
      ctaText:
        "Build a robust, secure, and scalable network infrastructure for your business",
    ...
    "cctv-surveillance": {
      ...
      heroText:
        "Advanced surveillance systems with AI-powered analytics, real-time monitoring, and comprehensive security solutions to protect your assets and ensure safety.",
      stats: [
        ["4", "K Resolution"],
        ["24", "Hour Monitoring"],
      ...
      capabilities: [
        [
          "IP Camera Systems",
          "High-definition IP cameras with night vision, motion detection, and remote access.",
          ["4K Ultra HD", "Night Vision", "Motion Detection", "Remote Access"],
        ],
        [
          "AI-Powered Analytics",
          "Facial recognition, behavior analysis, and real-time alerts powered by AI.",
          [
            "Facial Recognition",
            "Behavior Analysis",
            "Object Detection",
        ...
        [
          "Mobile Monitoring",
          "24/7 mobile app access with real-time notifications and cloud backup.",
          [
            "Mobile Access",
            "Instant Alerts",
            "Cloud Storage",
        ...
        [
          ...
          "Specialized camera formats for indoor, outdoor, perimeter, and intelligent tracking requirements.",
          ["Dome Cameras", "Bullet Cameras", "PTZ Cameras", "Thermal Cameras"],
        ],
      ],
      stacks: [
        ...
        [
          "Deployment Focus",
          ["Commercial Sites", "Retail Spaces", "Warehouses", "Campuses"],
        ],
      ],
      ...
      journey: [
        [
          "Assessment",
          "Review site layout, blind spots, storage needs, and operational risk points.",
        ],
        [
          "Design",
          "Map camera coverage, analytics zones, control access, and monitoring workflows.",
        ],
        [
          "Installation",
          "Deploy cameras, storage, connectivity, and app access with full system testing.",
        ],
        [
          "Monitoring",
          "Enable continuous alerts, analytics, and operational visibility across devices.",
        ],
        [
          "Support",
          "Maintain footage retention, system health, and future-ready security expansion.",
        ],
      ],
      ctaTitle: "Secure Your Property Today",
      ctaText:
        "Implement advanced surveillance systems with AI-powered monitoring and analytics",
      primaryCta: "Security Assessment",
      secondaryCta: "Contact Security Expert",
      primaryHref: "index.html#contact",
      secondaryHref: "index.html#contact",
  ...
  const solutions = [
    [
      "ilogic-web-pos",
      "Web POS",
      "Browser-based POS system accessible from any device with real-time cloud sync.",
      ["Cloud-based", "Multi-device", "Real-time sync"],
      "iLogic Web POS works across desktops, tablets, and smartphones with real-time inventory sync, analytics, and multi-location management.",
      "src/assets/Our Solutions/Web POS.png",
    ],
    [
      "ilogic-dine",
      "Dine Application",
      "Complete restaurant management with table ordering, kitchen display, and delivery.",
      ["Table management", "KDS integration", "Delivery tracking"],
      "iLogic Dine covers dine-in, takeaway, and delivery with menu management, split billing, order tracking, and QR self-ordering.",
      "src/assets/Our Solutions/Hotel Dine App.png",
    ],
    [
      "ilogic-cloud-erp",
      "ERP Management",
      "Enterprise resource planning with finance, HR, inventory, and procurement modules.",
      ["Finance and HR", "Inventory", "Multi-branch"],
      "iLogic Cloud ERP integrates finance, HR, inventory, procurement, project management, and CRM into one scalable platform.",
      "src/assets/Our Solutions/ERP.png",
    ],
    [
      "ilogic-ai-pos",
      "AI POS",
      "AI-powered POS with smart product recognition and predictive analytics.",
      ["AI recognition", "Predictive analytics", "Smart pricing"],
      "iLogic AI POS uses artificial intelligence for product recognition, inventory forecasting, dynamic pricing, and personalized promotions.",
      "src/assets/Our Solutions/AI POS.png",
    ],
    [
      "ilogic-cms",
      "CMS System",
      "Content management system for businesses to manage digital content and communications.",
      ["Page builder", "Multi-language", "SEO tools"],
      "iLogic CMS lets businesses manage websites, signage, and content from one platform.",
      "src/assets/Our Solutions/CMS.png",
    ],
    [
      "ilogic-transportation",
      "Transportation Application",
      "Fleet management and logistics tracking for transportation companies.",
      ["GPS tracking", "Route optimization", "Fleet management"],
      "iLogic Transportation App provides vehicle tracking, dispatch, fuel monitoring, maintenance scheduling, and reporting.",
      "src/assets/Our Solutions/Transporation App.png",
    ],
    [
      "ilogic-hospital-management",
      "Hospital Management",
      "Complete hospital management with patient records, billing, and appointment scheduling.",
      ["EMR", "Appointments", "Pharmacy"],
      "iLogic Hospital Management covers registration, medical records, billing, pharmacy, telemedicine, and inventory workflows.",
      "src/assets/Our Solutions/Hospital Management.png",
    ],
    [
      "ilogic-crm",
      "CRM System",
      "Customer relationship management for sales pipeline and customer engagement.",
      ["Lead management", "Email automation", "Analytics"],
      "iLogic CRM System helps businesses manage sales pipelines, automations, tasks, and analytics in one platform.",
      "src/assets/Our Solutions/CRM.png",
    ],
    [
      "ilogic-tailor",
      "Tailor Application",
      "Custom tailoring management with measurements, orders, and delivery tracking.",
      ["Measurements", "Order tracking", "Fabric inventory"],
      "iLogic Tailor Application supports tailoring businesses with measurement templates, inventory, reminders, and business analytics.",
      "src/assets/Our Solutions/Tailor App.png",
    ],
    [
      "ilogic-hotel-management",
      "Hotel Management",
      "Hotel property management with reservations, housekeeping, and guest services.",
      ["Reservations", "Housekeeping", "Guest services"],
      "iLogic Hotel Management covers reservations, housekeeping, check-in and check-out, and revenue analytics.",
  ...
  const solutionExperienceDetails = {
    "ilogic-web-pos": {
      ...
      intro:
        "A browser-based POS platform that lets businesses manage billing, inventory, sales, and customer data from anywhere without installing software.",
      stats: [
        ["Any", "Device Access"],
        ["Real-time", "Inventory"],
        ["Cloud", "Backup"],
      ...
      video: {
        src: "Video/pos.mp4",
        cues: [
          "Cloud-based POS for retail and F&B businesses.",
          "Manage billing, inventory, and customer data from any device.",
          "Get real-time analytics, offline sync, and secure staff access.",
          "Scale from one outlet to multiple locations with ease.",
        ],
      },
      sections: [
        {
          ...
          body: [
            "Our Web POS is designed for small and medium businesses that need a practical, affordable, and flexible cloud-based system.",
            "From user-friendly billing screens to secure cloud storage and live syncing, the platform adapts to your business without adding unnecessary complexity.",
          ],
        },
        {
          title: "Key Features",
          items: [
            "Cloud-based access",
            "Multiple payment methods including UPI, card, cash, and wallets",
        ...
        },
        {
          ...
          items: [
            ...
            "Real-time syncing across devices or branches",
          ],
        },
        {
          title: "How It Empowers Small Businesses",
          items: [
            "Simple, intuitive design with minimal training",
        ...
        },
        {
          ...
          items: [
            ...
            "Monitor sales trends across branches",
            "Identify best-selling products quickly",
          ],
        },
        {
          title: "Built to Grow",
          items: [
            ...
            "Multiple user logins with access control",
            "Integrations with eCommerce or delivery partners",
          ],
        },
        {
          title: "FAQs",
          faqs: [
            [
              "Do I need internet to use Web POS?",
              "Internet is required for cloud access and real-time data, but offline billing is available for uninterrupted sales.",
            ],
            [
              "Can I integrate Web POS with my existing system?",
              "Yes. iLogic Web POS supports API-based integration with ERP, CRM, and accounting systems.",
            ],
            [
              "Is it suitable for multiple branches?",
              "Yes. It supports centralized control and real-time tracking across multiple locations.",
            ],
            [
              "How secure is my business data?",
              "Data is encrypted, stored securely in the cloud, backed up regularly, and protected with role-based access.",
            ],
          ],
        },
      ],
      ...
      ctaText:
        "Contact iLogic Tech for a free demo or consultation and launch a faster, smarter, cloud-ready POS setup.",
    },
    "ilogic-dine": {
      eyebrow: "Restaurant POS",
      headline: "iLogic Dine - Restaurant POS System",
      intro:
        "A complete F&B POS platform for dine-in restaurants, cafes, food courts, QSRs, and cloud kitchens with ordering, kitchen workflows, and payment control in one place.",
      stats: [
        ["200", "Restaurants"],
        ["4", "Rating Star"],
        ["50", "Orders / Hour"],
      ...
      sections: [
        {
          ...
          body: [
            "Running a restaurant today is about speed, accuracy, guest experience, and operational efficiency. iLogic Dine helps restaurants manage tables, orders, payments, kitchen communication, and delivery channels from one system.",
            "It is built to support front-of-house service, back-of-kitchen coordination, and real-time management insight.",
          ],
        },
        {
          title: "Solving Real Challenges for F&B Businesses",
          items: [
            "Reduce slow table turnover and order mistakes with table management and QR ordering",
            "Get real-time sales analytics, stock tracking, and low inventory alerts",
            "Accept contactless payments, split bills, and digital wallets",
            "Consolidate online orders from multiple delivery platforms",
            "Automate receipts, tax calculations, and revenue tracking across dine-in, takeaway, and online sales",
          ],
        },
        {
          ...
          items: [
            ...
            "Kitchen display system for streamlined order fulfillment",
            "Digital menu and QR code ordering",
            "Customer and table management",
            "Built for both single outlets and multi-outlet chains",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            "Reduced order errors and manual work",
            "Faster billing and better customer experience",
            "Lower operational costs and reduced waste",
            "A platform designed for growth and expansion",
          ],
        },
      ],
      ctaTitle: "Ready to Transform Your Restaurant?",
      ctaText:
        "Power your restaurant with faster service, smarter insights, and total control from front-of-house to back-of-kitchen.",
    },
    "ilogic-cloud-erp": {
      eyebrow: "Enterprise Platform",
      headline: "Web Based ERP Solutions for Small Businesses in 2025",
      intro:
        "A modern cloud ERP platform that centralizes finance, inventory, HR, sales, and operations into one scalable system for growth-focused businesses.",
      stats: [
        ["100", "Enterprises"],
        ["50", "Cost Savings %"],
        ["15", "Modules"],
      ...
      sections: [
        {
          ...
          body: [
            "Cloud ERP is an internet-based system that automates and connects core business processes from finance and inventory to HR and customer support through one platform.",
            "Because it runs in the cloud, teams get secure, real-time access from anywhere without maintaining heavy on-premise infrastructure.",
          ],
        },
        {
          ...
          items: [
            ...
            "Integration with AI, IoT, and third-party tools",
          ],
        },
        {
          title: "Key Trends",
        ...
        },
        {
          ...
          items: [
            ...
            "Save costs with cloud infrastructure",
            "Collaborate better across departments",
            "Work remotely with secure mobile access",
          ],
        },
      ],
      ctaTitle: "Ready to Future-Proof Your Business?",
      ctaText:
        "Let iLogic Cloud ERP help you unify operations, improve decision-making, and scale with confidence.",
    },
    "ilogic-ai-pos": {
      eyebrow: "AI-Powered Retail",
      headline: "AI POS (Object Detection)",
      intro:
        "A next-generation retail POS system combining intelligent billing, live stock visibility, predictive analytics, and centralized multi-store control.",
      stats: [
        ["95", "AI Accuracy %"],
        ["30", "Sales Boost %"],
        ["24", "Hour Learning"],
      ...
      sections: [
        {
          ...
          items: [
            "Reduce long queues and manual billing errors with automated lookup and discounts",
            "Improve stock visibility with live tracking and AI-based demand forecasting",
            "See real-time performance across top products, peak hours, and staff output",
            "Control multiple outlets with centralized pricing, promotions, and reporting",
            "Accept cash, cards, QR, e-wallets, and split billing from one checkout flow",
          ],
        },
        {
          title: "The iLogic AI POS Advantage",
          items: [
            "AI-driven billing and product intelligence",
        ...
        },
        {
          ...
          items: [
            ...
            "Fewer stock mismanagement issues",
            "Higher customer satisfaction",
            "More store-wide visibility and control",
        ...
        },
        {
          title: "More Than POS",
          body: [
            "iLogic AI POS is designed to bring AI into daily retail operations so businesses can run smarter, sell faster, and scale with confidence.",
            "It supports both standalone stores and expanding retail groups with a practical, high-visibility operating model.",
          ],
        },
      ],
      ctaTitle: "Ready to Sell Smarter, Faster and Better?",
      ctaText:
        "Bring AI-powered retail intelligence into your checkout, stock planning, and store operations.",
    },
    "ilogic-cms": {
      eyebrow: "Cash Management",
      headline: "iLogic CMS",
      intro:
        "A smart Cash Management System plus POS platform for retail, supermarkets, multi-outlet stores, and category-driven businesses that need tighter control over transactions.",
      stats: [
      ...
      sections: [
        {
          ...
          body: [
            "A Cash Management System helps businesses monitor, secure, and reconcile cash transactions with greater speed and accuracy.",
            "iLogic CMS combines this capability with POS workflows to support businesses that need strong transaction control at scale.",
          ],
        },
        {
          ...
          items: [
            ...
            "Hotels, salons, and service centers",
            "Multi-outlet or franchise businesses",
          ],
        },
        {
          title: "What We Offer",
          items: [
            "Faster billing",
            "Reduced cash mishandling",
            "Real-time business insights",
            "Lower operational costs",
            "A future-ready, scalable setup",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            "Tighter control over manual cash handling",
      ...
      ctaText:
        "Switch to iLogic CMS for stronger cash flow visibility, better control, and smarter retail operations.",
    },
    "ilogic-transportation": {
      eyebrow: "Logistics Platform",
      headline: "iLogic Transportation",
      intro:
        "A transportation management solution for logistics providers, distributors, and delivery teams that need route optimization, GPS visibility, and dispatch control.",
      stats: [
        ["5000", "Vehicles"],
        ["25", "Fuel Savings %"],
        ["99", "GPS Accuracy %"],
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Centralized order and dispatch management",
        ...
        },
        {
          ...
          items: [
            ...
            "Cold chain and food delivery operators",
        ...
        },
        {
          ...
          body: [
            "From automatic driver alerts to intelligent load planning and compliance workflows, iLogic Transportation reduces manual effort while improving operational efficiency.",
            "It can also integrate with ERP, CRM, and inventory systems for more connected logistics execution.",
          ],
        },
      ],
      ctaTitle: "Book a Free Demo Today",
      ctaText:
        "See how iLogic Transportation can save planning time, improve visibility, and reduce fuel waste.",
    },
    "ilogic-hospital-management": {
      eyebrow: "Healthcare Platform",
      headline: "Healthcare Management System",
      intro:
        "A modern hospital and clinic management system that reduces admin load, secures patient data, and supports better care delivery through connected workflows.",
      stats: [
        ["50", "Hospitals"],
        ["100", "HIPAA Compliant"],
      ...
      sections: [
        {
          ...
          body: [
            "Healthcare organizations need more than records and billing tools. They need integrated scheduling, staff coordination, patient communication, and compliance support.",
            "iLogic Tech's Healthcare Management System helps facilities improve efficiency while keeping care at the center of operations.",
          ],
        },
        {
          ...
          items: [
            ...
            "Improve appointment scheduling and patient flow",
            "Protect sensitive patient data with strong security controls",
            "Automate billing and claim-related workflows",
            "Support remote consultations with telemedicine-ready capabilities",
          ],
        },
        {
          title: "Why Providers Trust iLogic Tech",
          items: [
            "Focus on care instead of admin work",
            "Get visibility into clinical and financial performance",
            "Scale from a single clinic to a hospital network",
            "Use workflows shaped by real healthcare professionals",
          ],
        },
        {
          ...
          items: [
            ...
            "Smoother alignment with existing processes",
          ],
        },
      ],
      ctaTitle: "Let's Transform Healthcare Together",
      ctaText:
        "Modernize patient operations, scheduling, billing, and reporting with a healthcare platform built for real-world teams.",
    },
    "ilogic-crm": {
      eyebrow: "Customer Growth",
      headline: "CRM",
      intro:
        "A cloud-based customer relationship management platform that centralizes leads, follow-ups, campaigns, and sales visibility for high-growth teams.",
      stats: [
        ["10000", "Customers"],
        ["40", "Sales Increase %"],
        ["95", "Lead Conversion %"],
      ...
      sections: [
        {
          ...
          body: [
            "iLogic CRM helps businesses manage leads, automate follow-ups, strengthen customer engagement, and accelerate revenue without relying on disconnected spreadsheets or tools.",
            "It is suited for SMEs and scaling enterprises that want cleaner sales and marketing execution.",
          ],
        },
        {
          title: "Solving Real CRM Challenges",
          items: [
            "Centralize scattered lead and contact data",
            "Automate reminders and follow-ups",
            "Track pipeline performance in real time",
            "Run targeted marketing campaigns",
            "Enable secure collaboration across sales, support, and marketing teams",
          ],
        },
        {
          title: "The iLogic CRM Advantage",
          items: [
            "Lead management and sales funnel tracking",
            "Marketing automation and campaigns",
            "Cloud access from desktop, tablet, and mobile",
            "Custom reports and dashboards",
            "Integrated communications",
            "Scalable workflows from SME to enterprise",
          ],
        },
        {
        ...
        },
        {
          ...
          faqs: [
            [
              "Who should use iLogic CRM?",
              "Any business that wants better lead management, follow-up automation, and customer visibility.",
            ],
            [
              "Can I access the CRM remotely?",
              "Yes. The cloud-based platform is securely available on desktop, tablet, and mobile.",
            ],
            [
              "Does it support multi-user collaboration?",
              "Yes. Teams can assign roles, tasks, and collaborate in real time.",
            ],
            [
              "How secure is iLogic CRM?",
              "It uses encrypted cloud hosting, strong data protection measures, and compliance-focused access controls.",
            ],
          ],
        },
      ],
      ...
      ctaText:
        "Use iLogic CRM as your sales partner, support manager, and marketing engine in one platform.",
    },
    "ilogic-tailor": {
      eyebrow: "Tailoring Software",
      headline: "Smart Tailoring Software for Modern Boutiques",
      intro:
        "A boutique-focused tailoring platform for measurements, trial dates, order tracking, invoicing, and delivery scheduling in one organized workflow.",
      stats: [
        ["Live", "Order Tracking"],
        ["Multi", "Branch Ready"],
        ["Cloud", "Access"],
      ...
      sections: [
        {
          ...
          body: [
            "Built for tailors and boutiques, this system keeps every measurement, fitting, and delivery date organized in one clean workflow.",
            "It reduces rework, improves turnaround time, and helps teams deliver a more professional customer experience.",
          ],
        },
        {
          title: "Key Features",
          items: [
            ...
            "Order and trial tracking",
            "Invoicing and payments",
            "Style and fabric catalog",
            "Delivery reminders",
            "Customer history",
            "Role-based access",
          ],
        },
        {
          ...
          items: [
            ...
            "Fashion academies",
            "Corporate tailors",
            "Event wear specialists",
            "Ethnic wear stores",
            "Fabric and stitching units",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            "See pending trials and due dates",
            "Generate receipts in seconds",
            "Monitor order volume by day or week",
        ...
        },
        {
          ...
          faqs: [
            [
              "Can I store multiple measurements per customer?",
              "Yes. You can save and reuse multiple measurement profiles for different garment types and occasions.",
            ],
            [
              "How do I track trials and delivery dates?",
              "Each order includes milestones and reminders for trials and delivery.",
            ],
            [
              "Is it suitable for multiple branches?",
              "Yes. Multi-branch management supports orders and customers across locations.",
            ],
            [
              "How secure is my business data?",
              "Data is encrypted, backed up in the cloud, and protected with role-based access.",
            ],
          ],
        },
      ],
      ...
      ctaText:
        "Book a free demo to simplify measurements, fittings, invoicing, and delivery tracking.",
    },
    "ilogic-hotel-management": {
  ...
  function list(items) {
    return (
      ...
      items
        .map(
          (item) =>
            '<div class="list-item"><span class="check" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><path d="M8 8.5h7.5V16"/><path d="M8.5 15.5 15.5 8.5"/><path d="M12 3.8c4.5 0 8.2 3.7 8.2 8.2s-3.7 8.2-8.2 8.2-8.2-3.7-8.2-8.2 3.7-8.2 8.2-8.2Z"/></svg></span><span>' +
            item +
            "</span></div>"
        )
        .join("") +
  ...
  function galleryGrid(items) {
    return items
      .map(
        (item) =>
          '<div class="gallery-image reveal"><img src="' +
          item +
          '" alt="Gallery image" loading="lazy" /></div>'
      )
      .join("");
  }
  ...
  function galleryCards(items) {
    return items
      .map(
        (item, index) =>
          '<article class="gallery-folder-card reveal">' +
          ...
          item.label +
          "</span>" +
          '<button class="gallery-folder-view" type="button" data-gallery-open="' +
          item.key +
          '" aria-label="View ' +
          item.title +
          ' gallery">View</button>' +
          ...
          item.subtitle +
          "</p>" +
          '<span class="gallery-folder-location">' +
          item.location +
          "</span>" +
          "</div>" +
          "</div>" +
  ...
  function sectionHeader(eyebrow, title, text) {
    return (
      '<div class="section-heading reveal"><span class="eyebrow">' +
      eyebrow +
      '</span><h2 class="gradient-text">' +
      title +
      "</h2>" +
  ...
  function metricCards(items) {
    return (
      ...
      items
        .map(
          (item) =>
            '<article class="glass service-metric-card reveal"><strong>' +
            item[0] +
            "</strong><span>" +
            item[1] +
            "</span></article>"
  ...
  function serviceFeatureCards(items) {
    return (
      ...
      items
        .map(
          (item) =>
            '<article class="glass service-feature-card reveal"><div class="icon-badge service-icon-badge">' +
            serviceFeatureIcon(item[0]) +
            "</div><h3>" +
            item[0] +
            '</h3><p class="muted">' +
            item[1] +
            '</p><ul class="service-points">' +
            item[2].map((point) => "<li>" + point + "</li>").join("") +
            "</ul></article>"
        )
        .join("") +
      "</div>"
  ...
  function serviceStackRows(items) {
    return (
      ...
      items
        .map(
          (item) =>
            '<article class="glass service-stack-card reveal"><h3>' +
            item[0] +
            '</h3><div class="tag-list">' +
            item[1].map((tag) => "<span>" + tag + "</span>").join("") +
            "</div></article>"
        )
        .join("") +
      "</div>"
  ...
  function serviceJourney(items) {
    return (
      '<div class="service-journey-list">' +
      items
        .map(
          (item) =>
            '<article class="glass service-journey-card reveal"><div class="service-journey-badge">' +
            serviceJourneyIcon(item[0]) +
            "</div><div><h3>" +
            item[0].replace(/^\\d+\\s+/, "") +
            '</h3><p class="muted">' +
            item[1] +
  ...
  function serviceIcon(slug) {
    const icons = {
      "software-development":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3.5" y="5" width="17" height="12" rx="2.4"/><path d="M7 19.5h10"/><path d="M8.2 10 6.4 11.8 8.2 13.6"/><path d="m15.8 10 1.8 1.8-1.8 1.8"/><path d="m13.1 8.7-2.2 6.2"/></svg>',
      "web-applications":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="7.5"/><path d="M4.5 12h15"/><path d="M12 4.5a12 12 0 0 1 0 15"/><path d="M12 4.5a12 12 0 0 0 0 15"/></svg>',
      "mobile-apps":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="7.2" y="2.8" width="9.6" height="18.4" rx="2.2"/><path d="M10.2 6h3.6"/><circle cx="12" cy="17.6" r="1"/><path d="M10 12.2h4"/></svg>',
      "ai-ml":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="8" cy="8" r="2.2"/><circle cx="16" cy="8" r="2.2"/><circle cx="8" cy="16" r="2.2"/><circle cx="16" cy="16" r="2.2"/><path d="M10.2 8h3.6M8 10.2v3.6M16 10.2v3.6M10.2 16h3.6"/></svg>',
      cybersecurity:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3.5 6.5 5.8v5.1c0 3.8 2.3 6.7 5.5 8.8 3.2-2.1 5.5-5 5.5-8.8V5.8L12 3.5Z"/><path d="M9.8 12.1 11.5 13.8 14.6 10.4"/></svg>',
      networking:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5.2 9.6A10.6 10.6 0 0 1 12 7a10.6 10.6 0 0 1 6.8 2.6"/><path d="M8.2 12.7A6.7 6.7 0 0 1 12 11.5a6.7 6.7 0 0 1 3.8 1.2"/><path d="M10.8 15.8a2.7 2.7 0 0 1 2.4 0"/><circle cx="12" cy="18.2" r="1.1"/></svg>',
      "cctv-surveillance":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 9.2h9.5l4-3.2H9.1L5 9.2Z"/><path d="m8 9.5 1.7 4.6"/><path d="M9.7 14.1H7"/><path d="M15.3 12.7a4.5 4.5 0 0 1 4.4 0"/><path d="M16.4 14.9a2.3 2.3 0 0 1 2.2 0"/></svg>',
      "internship-program":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 7.5 12 4l7 3.5-7 3.5L5 7.5Z"/><path d="M8 10v4.2c0 1.5 1.8 2.8 4 2.8s4-1.3 4-2.8V10"/><path d="M19 8v4"/></svg>',
      "language-training":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 6.5h9.5a3.5 3.5 0 0 1 3.5 3.5v7.5H8.5A3.5 3.5 0 0 0 5 21V6.5Z"/><path d="M8.2 10h6.2M8.2 13h5.1"/><path d="M18.5 7.8 20 6.5v9"/></svg>',
    };
    return (
      icons[slug] ||
  ...
  function serviceFeatureIcon(title) {
    const icons = {
      "Desktop Applications":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3.5" y="5" width="17" height="11.5" rx="2.2"/><path d="M9 19h6"/><path d="M12 16.5V19"/></svg>',
      "Enterprise Software":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="4.5" width="16" height="4.5" rx="1.2"/><rect x="4" y="10" width="16" height="4.5" rx="1.2"/><rect x="4" y="15.5" width="16" height="4" rx="1.2"/><path d="M8 7h.01M8 12.3h.01M8 17.4h.01"/></svg>',
      "Custom Development":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.2 8.8 5.4 12l2.8 3.2"/><path d="m15.8 8.8 2.8 3.2-2.8 3.2"/><path d="m13.4 6.8-2.8 10.4"/></svg>',
      "Database Solutions":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><ellipse cx="12" cy="6.5" rx="6.5" ry="2.8"/><path d="M5.5 6.5v5c0 1.5 2.9 2.8 6.5 2.8s6.5-1.3 6.5-2.8v-5"/><path d="M5.5 11.5v5c0 1.5 2.9 2.8 6.5 2.8s6.5-1.3 6.5-2.8v-5"/></svg>',
      "API Development":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.3 8.8 5.5 12l2.8 3.2"/><path d="m15.7 8.8 2.8 3.2-2.8 3.2"/><rect x="9.6" y="9.2" width="4.8" height="5.6" rx="1.3"/></svg>',
      "Software Maintenance":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14.8 5.8a4.6 4.6 0 0 1 3.4 5.9l-4.1 4.1a2.2 2.2 0 0 1-3.1 0l-2.8-2.8a2.2 2.2 0 0 1 0-3.1l4.1-4.1a4.6 4.6 0 0 1 2.5-1.2Z"/><path d="m9.1 14.9-3.6 3.6"/><path d="M6.2 17.8 4.8 19.2"/></svg>',
      "Frontend Development":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.2 8.8 5.4 12l2.8 3.2"/><path d="m15.8 8.8 2.8 3.2-2.8 3.2"/><path d="M9.6 6.5h4.8"/><path d="M9.6 17.5h4.8"/></svg>',
      "Backend Development":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><ellipse cx="12" cy="7" rx="5.8" ry="2.4"/><path d="M6.2 7v4.5c0 1.3 2.6 2.4 5.8 2.4s5.8-1.1 5.8-2.4V7"/><path d="M6.2 11.5V16c0 1.3 2.6 2.4 5.8 2.4s5.8-1.1 5.8-2.4v-4.5"/></svg>',
      "E-commerce Solutions":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="18" r="1.4"/><circle cx="17" cy="18" r="1.4"/><path d="M4.5 6h2l1.6 7.2h8.8l1.8-5.2H7.4"/><path d="M10 6V4.5h4V6"/><path d="M12 10.4v2.4"/><path d="M10.8 11.6h2.4"/></svg>',
      "Performance Optimization":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 16.5a7 7 0 1 1 12 0"/><path d="M12 12l3.5-3.5"/><path d="M12 18.5h.01"/></svg>',
      "iOS Development":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14.2 7.1c-.6.7-1.6 1.2-2.5 1.1-.1-.9.3-1.8.8-2.4.6-.7 1.6-1.2 2.4-1.2.1.9-.2 1.8-.7 2.5Z"/><path d="M12.1 9.4c1.3 0 1.9-.9 3.3-.9 1.1 0 1.9.5 2.5 1.3-2.2 1.2-1.8 4.4.5 5.4-.6 1.3-1.4 2.6-2.7 2.6-1.2 0-1.6-.8-3-.8s-1.8.8-3 .8c-1.2 0-2.1-1.2-2.7-2.5-1.6-3-.7-6.1 1.1-7.1 1.1-.6 2.2-.6 3 .1.5.4.9 1.1 1 1.1Z"/></svg>',
      "Android Development":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 9.5h8a2 2 0 0 1 2 2v4.6a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-4.6a2 2 0 0 1 2-2Z"/><path d="m9.2 6.8-1-1.6"/><path d="m14.8 6.8 1-1.6"/><path d="M9.5 9.5V7.8A2.5 2.5 0 0 1 12 5.3a2.5 2.5 0 0 1 2.5 2.5v1.7"/><circle cx="10" cy="13.2" r=".4"/><circle cx="14" cy="13.2" r=".4"/></svg>',
      "Cross-Platform":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3.8" y="5" width="7.8" height="5.7" rx="1.3"/><rect x="12.4" y="13.3" width="7.8" height="5.7" rx="1.3"/><path d="M11.6 8h1.8v2.1h-2.1v1.7"/><path d="M12.4 16.1h-1.8V14h2.1v-1.7"/></svg>',
      "Specialized App Solutions":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5.2a2.8 2.8 0 1 1 0 5.6 2.8 2.8 0 0 1 0-5.6Z"/><path d="M6.5 18.4a5.8 5.8 0 0 1 11 0"/><path d="M5.2 9.3h2.2"/><path d="M16.6 9.3h2.2"/><path d="M4.4 13.4h2"/><path d="M17.6 13.4h2"/></svg>',
      "Penetration Testing":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.5 7 6.7v4.9c0 3 1.8 5.4 5 7.4 3.2-2 5-4.4 5-7.4V6.7L12 4.5Z"/><path d="m9.4 12 1.7 1.7 3.5-4"/><path d="m15.8 15.8 2.7 2.7"/></svg>',
      "Security Monitoring":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 12h2.8l1.6-3.1 2.4 6.2 1.8-4h6.4"/><path d="M12 4.5a7.5 7.5 0 1 1 0 15 7.5 7.5 0 0 1 0-15Z"/></svg>',
      "Identity & Access Management":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5.2a2.9 2.9 0 1 1 0 5.8 2.9 2.9 0 0 1 0-5.8Z"/><path d="M6.8 18.5a5.6 5.6 0 0 1 10.4 0"/><rect x="15.2" y="10.8" width="4.6" height="3.7" rx="1"/><path d="M16.2 10.8V9.9a1.3 1.3 0 0 1 2.6 0v.9"/></svg>',
      "Data Protection":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.5 7 6.5v5.2c0 3.1 1.9 5.6 5 7.5 3.1-1.9 5-4.4 5-7.5V6.5L12 4.5Z"/><rect x="10.1" y="10.1" width="3.8" height="3.2" rx=".7"/><path d="M10.8 10.1V9.3a1.2 1.2 0 1 1 2.4 0v.8"/></svg>',
      "Security Training":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 7.2 12 4l7 3.2-7 3.2L5 7.2Z"/><path d="M8 10.1v4.2c0 1.5 1.8 2.7 4 2.7s4-1.2 4-2.7v-4.2"/><path d="M19 8.2v4"/><path d="M12 12.2v2.1"/></svg>',
      "Compliance Management":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="6.2" y="4.5" width="11.6" height="15" rx="1.6"/><path d="M9.2 9.2h5.6"/><path d="M9.2 12.2h5.6"/><path d="m9.2 15.2 1.2 1.2 2.4-2.8"/></svg>',
      "Network Design & Architecture":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3.8" y="5" width="4.6" height="4.6" rx="1"/><rect x="15.6" y="5" width="4.6" height="4.6" rx="1"/><rect x="9.7" y="14.4" width="4.6" height="4.6" rx="1"/><path d="M8.4 7.3h7.2"/><path d="M12 9.6v4.8"/></svg>',
      "Wireless Solutions":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5.2 10.4A10.3 10.3 0 0 1 12 8a10.3 10.3 0 0 1 6.8 2.4"/><path d="M8.1 13.2A6.6 6.6 0 0 1 12 12a6.6 6.6 0 0 1 3.9 1.2"/><path d="M10.7 16a2.7 2.7 0 0 1 2.6 0"/><circle cx="12" cy="18.4" r="1"/></svg>',
      "Network Security":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.5 7 6.8v4.9c0 3 1.8 5.4 5 7.3 3.2-1.9 5-4.3 5-7.3V6.8L12 4.5Z"/><path d="m9.8 12.1 1.6 1.6 2.8-3.3"/></svg>',
      "Network Monitoring":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 12h3l1.3-2.8 2.6 5.6 1.8-3.8h6.3"/><path d="M4.5 18.2h15"/></svg>',
      "Data Center Networking":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="6.2" y="4.5" width="11.6" height="4" rx="1"/><rect x="6.2" y="10" width="11.6" height="4" rx="1"/><rect x="6.2" y="15.5" width="11.6" height="4" rx="1"/><path d="M9 6.5h.01M9 12h.01M9 17.5h.01"/></svg>',
      "Network Maintenance":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14.9 6.1a4.4 4.4 0 0 1 2.9 5.8l-4 4a2.1 2.1 0 0 1-3 0l-2.7-2.7a2.1 2.1 0 0 1 0-3l4-4a4.4 4.4 0 0 1 2.8-1.1Z"/><path d="m8.9 15.1-3.4 3.4"/><path d="M6.1 17.9 4.8 19.2"/></svg>',
      "IP Camera Systems":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.8 9.4h8.9l4.3-3.2H9.2L4.8 9.4Z"/><path d="m7.8 9.7 1.8 4.6"/><path d="M9.6 14.3H6.8"/><circle cx="17.4" cy="12.7" r="1.4"/><path d="M14.9 12.7a2.5 2.5 0 0 1 5 0"/></svg>',
      "AI-Powered Analytics":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5.2a2.7 2.7 0 1 1 0 5.4 2.7 2.7 0 0 1 0-5.4Z"/><path d="M7.2 18.2a5.4 5.4 0 0 1 9.6 0"/><path d="M5.3 12h1.9"/><path d="M16.8 12h1.9"/><path d="m8.3 8.2-1.4-1.4"/><path d="m15.7 8.2 1.4-1.4"/></svg>',
      "Mobile Monitoring":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="7.3" y="2.8" width="9.4" height="18.4" rx="2.2"/><path d="M10.1 5.8h3.8"/><path d="M9.8 12h4.4"/><path d="M10.3 15.1h3.4"/><circle cx="12" cy="17.9" r=".9"/></svg>',
      "Professional Camera Solutions":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 9.4h10l4.5-3.2H9.4L4.5 9.4Z"/><path d="m8 9.7 1.5 4.2"/><path d="M9.5 13.9H6.8"/><path d="M15.2 11.5a3.8 3.8 0 0 1 3.8 0"/><path d="M14.4 14a5.5 5.5 0 0 1 5.2 0"/></svg>',
    };
    return (
      icons[title] ||
      '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="7"/></svg>'
  ...
  function serviceJourneyIcon(title) {
    ...
    const icons = {
      "Discovery & Planning":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="5.5"/><path d="m15.2 15.2 3.3 3.3"/><path d="M11 8.5v2.8l1.9 1.2"/></svg>',
      "Design & Prototyping":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m5 16.8-.8 3.2 3.2-.8L18 8.6 15.4 6 5 16.8Z"/><path d="m13.8 7.6 2.6 2.6"/><path d="M8.8 18.2h6.7"/></svg>',
      "Development & Testing":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.2 8.8 5.4 12l2.8 3.2"/><path d="m15.8 8.8 2.8 3.2-2.8 3.2"/><path d="m13.3 6.8-2.6 10.4"/><path d="m9.8 15.8 1.4 1.4 3-3.4"/></svg>',
      "Deployment & Support":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.5 6.8 7.1v4.8c0 3.2 1.9 5.7 5.2 7.6 3.3-1.9 5.2-4.4 5.2-7.6V7.1L12 4.5Z"/><path d="m9.8 12.1 1.7 1.7 2.9-3.3"/></svg>',
      "Ideation & Strategy":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9.6 14.8a4.7 4.7 0 1 1 6.8 0L12 19.1l-2.4-2.4Z"/><path d="M12 8.5v2.7"/><path d="M12 14.4h.01"/></svg>',
      "UI/UX Design":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m5 16.8-.8 3.2 3.2-.8L18 8.6 15.4 6 5 16.8Z"/><path d="m13.8 7.6 2.6 2.6"/><path d="M8.6 18.4h6.8"/></svg>',
      Development:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.2 8.8 5.4 12l2.8 3.2"/><path d="m15.8 8.8 2.8 3.2-2.8 3.2"/><path d="m13.4 6.8-2.8 10.4"/></svg>',
      "Testing & QA":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="10.5" cy="10.5" r="4.8"/><path d="m14.1 14.1 4 4"/><path d="m9.2 10.6 1.1 1.1 2.1-2.4"/></svg>',
      "Launch & Support":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.8c3.5 2 5.6 5.3 5.6 9.3 0 1.7-.5 3.3-1.4 4.7l-4.2-1.8-4.2 1.8a8.9 8.9 0 0 1-1.4-4.7c0-4 2.1-7.3 5.6-9.3Z"/><path d="M12 9.3v4.8"/><path d="m10.2 11.1 1.8-1.8 1.8 1.8"/></svg>',
      Assess:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="5.5"/><path d="m15.2 15.2 3.3 3.3"/><path d="M11 8.4v2.9l1.8 1.1"/></svg>',
      Protect:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.5 7 6.7v5c0 3 1.8 5.4 5 7.3 3.2-1.9 5-4.3 5-7.3v-5L12 4.5Z"/><path d="m9.8 12.1 1.6 1.6 2.8-3.3"/></svg>',
      Detect:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 12h2.8l1.6-3.1 2.4 6.2 1.8-4h6.4"/><path d="M12 4.5a7.5 7.5 0 1 1 0 15 7.5 7.5 0 0 1 0-15Z"/></svg>',
      Respond:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.5a7.5 7.5 0 1 1-7.5 7.5"/><path d="M4.5 7.5V4.5H7.5"/><path d="M12 8.5v3.1l2.2 1.5"/></svg>',
      Recover:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5.2 12a6.8 6.8 0 1 0 2-4.8"/><path d="M4.5 7.2v3.3h3.3"/><path d="m10.2 12.4 1.4 1.4 2.6-2.8"/></svg>',
      Design:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m5 16.8-.8 3.2 3.2-.8L18 8.6 15.4 6 5 16.8Z"/><path d="m13.8 7.6 2.6 2.6"/></svg>',
      Deploy:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5v10.2"/><path d="m8.5 11.7 3.5 3.5 3.5-3.5"/><rect x="5.5" y="17.2" width="13" height="2.8" rx="1.1"/></svg>',
      Monitor:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 12h3l1.3-2.8 2.6 5.6 1.8-3.8h6.3"/><path d="M4.5 18.2h15"/></svg>',
      Optimize:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 16.5a7 7 0 1 1 12 0"/><path d="M12 12l3.5-3.5"/><path d="M12 18.5h.01"/></svg>',
      ...
      Monitoring:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 12h3l1.3-2.8 2.6 5.6 1.8-3.8h6.3"/><path d="M4.5 18.2h15"/></svg>',
      Support:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.8 18.2v-1.5a3.2 3.2 0 0 1 6.4 0v1.5"/><circle cx="12" cy="9.2" r="2.6"/><path d="M5.8 11.4a6.2 6.2 0 1 1 12.4 0v3.3a1.7 1.7 0 0 1-1.7 1.7h-1.3"/></svg>',
    };
    return (
      icons[cleanTitle] ||
      '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="7"/></svg>'
  ...
  function serviceThemeStyle(slug) {
    const themes = {
      "software-development":
        "--service-accent:#7c3aed;--service-accent-soft:rgba(124,58,237,0.14);--service-accent-2:#ec4899;--service-surface:linear-gradient(180deg, rgba(255,255,255,0.98), rgba(248,241,255,0.98));",
      "web-applications":
        "--service-accent:#2563eb;--service-accent-soft:rgba(37,99,235,0.14);--service-accent-2:#06b6d4;--service-surface:linear-gradient(180deg, rgba(255,255,255,0.98), rgba(239,248,255,0.98));",
      "mobile-apps":
        "--service-accent:#db2777;--service-accent-soft:rgba(219,39,119,0.14);--service-accent-2:#f59e0b;--service-surface:linear-gradient(180deg, rgba(255,255,255,0.98), rgba(255,243,248,0.98));",
      cybersecurity:
        "--service-accent:#059669;--service-accent-soft:rgba(5,150,105,0.14);--service-accent-2:#14b8a6;--service-surface:linear-gradient(180deg, rgba(255,255,255,0.98), rgba(239,253,248,0.98));",
      networking:
        "--service-accent:#0f766e;--service-accent-soft:rgba(15,118,110,0.14);--service-accent-2:#3b82f6;--service-surface:linear-gradient(180deg, rgba(255,255,255,0.98), rgba(239,251,251,0.98));",
      "cctv-surveillance":
        "--service-accent:#ea580c;--service-accent-soft:rgba(234,88,12,0.14);--service-accent-2:#ef4444;--service-surface:linear-gradient(180deg, rgba(255,255,255,0.98), rgba(255,247,237,0.98));",
    };
    return (
      themes[slug] ||
      "--service-accent:var(--primary);--service-accent-soft:rgba(139,92,246,0.14);--service-accent-2:var(--accent);--service-surface:linear-gradient(180deg, rgba(255,255,255,0.98), rgba(247,241,255,0.98));"
    );
  }
  ...
  function aboutIcon(title) {
    const icons = {
      "Client-Centric":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5.2a3 3 0 1 1 0 6 3 3 0 0 1 0-6Z"/><path d="M6.8 18.2a5.7 5.7 0 0 1 10.4 0"/><path d="M18.3 7.8h1.7M19.1 7v1.7"/></svg>',
      "Scalable and Secure":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3 6.5 5.5v5c0 3.8 2.3 6.6 5.5 8.7 3.2-2.1 5.5-4.9 5.5-8.7v-5L12 3Z"/><path d="M9.8 11.2 11.4 13l3-3.4"/></svg>',
      "R&D Innovation":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9.5 14.8a4.8 4.8 0 1 1 6.8 0L12 19.3l-2.5-2.5Z"/><path d="M12 8.6v3.2"/><path d="M12 15.6h.01"/></svg>',
      "Quick Deployment":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13.8 4.5 7.4 12h4.3l-1 7.5 6.8-8H13l.8-7Z"/></svg>',
      "POS Solutions":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="4.5" width="14" height="10" rx="2"/><path d="M8 8.3h8"/><path d="M9 19.5h6"/><path d="M12 14.5v5"/></svg>',
      "IT Infrastructure":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5v3.2"/><path d="M6.5 18.5v-2.3h11v2.3"/><rect x="4" y="9.2" width="4.2" height="4" rx="1"/><rect x="9.9" y="9.2" width="4.2" height="4" rx="1"/><rect x="15.8" y="9.2" width="4.2" height="4" rx="1"/></svg>',
      "Training Programs":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 7.5 12 4l7 3.5-7 3.5L5 7.5Z"/><path d="M8 10v4.2c0 1.5 1.8 2.8 4 2.8s4-1.3 4-2.8V10"/><path d="M19 8v4"/></svg>',
      "LanguageCert Partner":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.5 7 6.2v5.1c0 3.1 1.9 5.6 5 7.7 3.1-2.1 5-4.6 5-7.7V6.2L12 4.5Z"/><path d="m9.8 12 1.6 1.6 2.8-3.2"/></svg>',
    };
    return (
      icons[title] ||
      '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="7"/></svg>'
  ...
  function countryToggle(className) {
    return (
      ...
      className +
      '" role="group" aria-label="Select country">' +
      countryOptions
        .map(
          (option) =>
            '<button class="country-chip" type="button" data-country="' +
            option.code +
  ...
  function socialIcon(network) {
    const icons = {
      instagram:
        '<img class="social-img-icon" src="src/assets/Social%20media/instagram.png" alt="Instagram" loading="lazy" />',
      x: '<img class="social-img-icon" src="src/assets/Social%20media/X.png" alt="X" loading="lazy" />',
      linkedin:
        '<img class="social-img-icon" src="src/assets/Social%20media/Linkedin.jpg" alt="LinkedIn" loading="lazy" />',
      facebook:
        '<img class="social-img-icon" src="src/assets/Social%20media/Fb.jpg" alt="Facebook" loading="lazy" />',
      youtube:
        '<img class="social-img-icon" src="src/assets/Social%20media/Youtube.png" alt="YouTube" loading="lazy" />',
    };
  ...
  function examModuleIcon(kind) {
    const icons = {
      languagecert:
        '<img src="' + languageCertLogo + '" alt="LanguageCert logo" />',
      celpip: '<img src="' + celpipPartnerLogo + '" alt="CELPIP logo" />',
      academic:
        '<img src="' + academicPartnerLogo + '" alt="Academic Partner logo" />',
      global:
        '<img src="' +
        globalCertificateLogo +
        '" alt="Global Certifications logo" />',
      enquiry:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5.5 6.2h13a1.8 1.8 0 0 1 1.8 1.8v8a1.8 1.8 0 0 1-1.8 1.8h-13A1.8 1.8 0 0 1 3.7 16V8a1.8 1.8 0 0 1 1.8-1.8Z"/><path d="m5 7 7 5 7-5"/></svg>',
      feedback:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 18.2 4.5 20v-4.5A6.5 6.5 0 0 1 11 9h4a6.5 6.5 0 0 1 0 13H11a6.4 6.4 0 0 1-4-1.4"/><path d="m12 6.2 1.3 2.6 2.8.4-2 2 .5 2.8-2.6-1.4-2.6 1.4.5-2.8-2-2 2.8-.4L12 6.2Z"/></svg>',
    };
  ...
  function certificationProgramIcon(name) {
    const icons = {
      ...
      Cisco:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 15.5h14"/><path d="M8 12.5V9.8M10.5 12.5V7.8M13 12.5V6.5M15.5 12.5V7.8M18 12.5V9.8"/></svg>',
      Azure:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12.2 4 6 18.5h3.7l1.4-3.5h4.3l1.4 3.5H20L13.5 4Z"/><path d="M12.8 8.2 14.6 13h-3.7Z"/></svg>',
      CompTIA:
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4.5 6.8 6.7v5c0 3 1.8 5.4 5.2 7.3 3.4-1.9 5.2-4.3 5.2-7.3v-5L12 4.5Z"/><path d="M9.6 11.8h4.8M9.6 14.2h3.2"/></svg>',
      "Google Cloud":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.5 17.5h7.4a3.6 3.6 0 0 0 .3-7.1 4.9 4.9 0 0 0-9.5 1.2A3.2 3.2 0 0 0 8.5 17.5Z"/><path d="M9.4 11.4a3.3 3.3 0 0 1 5.7-1.8"/></svg>',
      "Red Hat":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.2 13.2c1.1-2.8 4-4.6 6.9-4.6 2.7 0 4.7 1.4 4.7 3.4 0 2.4-2.6 4.1-6.1 4.1-2.7 0-4.9-1-5.5-2.9Z"/><path d="M8.6 8.8c.8-1.9 2.8-3.3 4.9-3.3 1.9 0 3.2.9 3.2 2.3 0 1.7-1.8 2.8-4.4 2.8-1.8 0-3.2-.6-3.7-1.8Z"/></svg>',
    };
  ...
  function enquiryForm(formId, examType, buttonLabel) {
    return (
      '<form class="exam-form" id="' +
      formId +
      '" data-enquiry-form data-exam-type="' +
      examType +
      '">' +
      ...
      '<label><span>Exam Type</span><input type="text" name="examType" value="' +
      examType +
      '" readonly /></label>' +
      "</div>" +
      ...
      examFeedbackSocials
        .map(
          (item) =>
            '<a class="exam-social-link" href="' +
            item[1] +
            '" target="_blank" rel="noreferrer noopener" aria-label="' +
            item[0] +
            '"><span class="exam-social-icon">' +
            socialIcon(item[2]) +
            "</span><span>" +
            item[0] +
            "</span></a>"
      ...
      '<div class="exam-form-actions"><button class="btn btn-primary" type="submit">' +
      buttonLabel +
      "</button></div>" +
      "</form>"
    );
  ...
  function examSeoHeroSection() {
    return (
      '<section class="section hero"><div class="container" style="text-align:center;max-width:64rem;">' +
  ...
  function examSeoWhyChooseSection() {
    return (
      '<section class="section exam-shell section-muted" id="exam-why-choose"><div class="container">' +
      sectionHeader(
        "Why Choose iLogic Tech",
        "Professional &amp; Authorized Exam Support",
        "Key advantages for international exams and certification services in South India."
      ) +
      '<article class="glass card reveal">' +
      list([
        "Authorized examination support",
        "International certification services",
        "LanguageCert examination assistance",
        "CELPIP examination support",
        "Prometric partner support",
        "BeingCert certification services",
        "Professional candidate assistance",
        "Secure examination process",
        "Convenient registration guidance",
        "Support for international certification requirements",
      ]) +
      "</article>" +
      "</div></section>"
    );
  ...
  function examSeoLocationsSection() {
    ...
    return (
      '<section class="section exam-shell" id="exam-locations"><div class="container">' +
      sectionHeader(
        "Locations We Serve",
        "Madurai, Pondicherry &amp; Nearby Regions",
        "Candidates from surrounding areas can connect with iLogic Tech for authorized exam services."
      ) +
  ...
  function examSeoFaqSection() {
    const faqs = [
      [
        "What exams are available at iLogic Tech?",
        "We provide authorized support for LanguageCert, CELPIP, and BeingCert examinations and certification services.",
      ],
      [
        "Is iLogic Tech an authorized LanguageCert partner?",
        "Yes, iLogic Tech supports LanguageCert examination services in Pondicherry.",
      ],
      [
        "Do you support CELPIP examinations?",
        "Yes, we provide CELPIP examination support in Pondicherry through Prometric partner services.",
      ],
      [
        "Who can register for international certification exams?",
        "Students, professionals, migration candidates, and job seekers can register for international certification examinations.",
      ],
    ];
    return (
      '<section class="section exam-shell" id="exam-faq"><div class="container">' +
      sectionHeader(
        "FAQ",
        "Frequently Asked Questions",
        "Quick answers for candidates planning to register for international exams and certifications."
      ) +
  ...
  function examSeoConclusionSection() {
    return (
      '<section class="section exam-shell section-muted" id="exam-conclusion"><div class="container">' +
  ...
  function examHubSection() {
    ...
    return (
      '<section class="section exam-shell section-muted" id="exam"><div class="container">' +
      sectionHeader(
        "Exam",
        "International Exam &amp; Certification Services",
        "Explore LanguageCert, CELPIP, and BeingCert certification programs, exam registration, partnership opportunities, and support services."
      ) +
      '<div class="exam-grid exam-grid-3">' +
      examCategories
        .map(
          (item) =>
            '<article class="glass card reveal exam-feature-card"><div class="exam-icon-badge' +
            (item[2] === "academic" ||
            item[2] === "languagecert" ||
            item[2] === "global" ||
            item[2] === "celpip"
              ...
              : "") +
            '">' +
            examModuleIcon(item[2]) +
            "</div><h3>" +
            item[0] +
            '</h3><p class="muted">' +
            item[1] +
            '</p><a class="btn btn-secondary" href="#exam-' +
            examSectionId(item[2]) +
  ...
  function celpipExamSection() {
    return (
      '<section class="section exam-shell" id="exam-celpip"><div class="container">' +
      ...
      "</div>" +
      '<div class="exam-panel-art"><div class="exam-hero-mark exam-logo-badge">' +
      examModuleIcon("celpip") +
      "</div><p>Prometric partner assistance for exam selection, registration, and exam-day readiness.</p></div>" +
      "</div>" +
      ...
      "</article>" +
      '<div class="glass card reveal exam-form-card is-hidden" id="celpipFormWrap">' +
      enquiryForm("celpipForm", "CELPIP", "Submit Enquiry") +
      "</div>" +
      "</div></section>"
    );
  }
  ...
  function languageCertExamSection() {
    return (
      '<section class="section exam-shell" id="exam-languagecert"><div class="container">' +
      '<div class="exam-panel glass reveal">' +
      '<div class="exam-panel-copy">' +
      ...
      "</div>" +
      '<div class="exam-panel-art"><div class="exam-hero-mark exam-logo-badge">' +
      examModuleIcon("languagecert") +
      "</div><p>Guidance for internationally trusted English proficiency and certification pathways.</p></div>" +
      "</div>" +
      ...
      "</div>" +
      '<div class="glass card reveal exam-form-card is-hidden" id="languagecertFormWrap">' +
      enquiryForm("languagecertForm", "LanguageCert", "Submit Enquiry") +
      "</div>" +
      "</div></section>"
    );
  }
  ...
  function academicPartnerSection() {
    return (
      '<section class="section exam-shell section-muted" id="exam-academic-partner"><div class="container">' +
      '<div class="exam-grid exam-grid-2">' +
      '<article class="glass card reveal exam-partner-card"><div class="exam-badge">Authorized Partner Support</div><div class="exam-partner-logos"><div class="exam-partner-logo-frame"><img src="' +
      languageCertLogo +
      '" alt="LanguageCert logo" /></div><div class="exam-partner-logo-frame"><img src="' +
      academicPartnerLogo +
      '" alt="Academic Partner logo" /></div></div><h3>Authorized BeingCert Certification Support in Pondicherry</h3><p class="muted">iLogic Tech provides authorized BeingCert certification support for candidates and professionals seeking international certification recognition and professional qualification opportunities.</p><button class="btn btn-primary" type="button" data-exam-toggle-form="academicPartnerForm">Enquire Now</button></article>' +
      ...
      "</div>" +
      '<div class="glass card reveal exam-form-card is-hidden" id="academicPartnerFormWrap">' +
      enquiryForm(
        "academicPartnerForm",
        "Academic Partner (BeingCert)",
        "Send Enquiry"
      ) +
      "</div>" +
      "</div></section>"
  ...
  function globalCertificationSection() {
    return (
      '<section class="section exam-shell" id="exam-global-certifications"><div class="container">' +
      sectionHeader(
        "Global Certification Programs",
        "Industry Certifications for Career Growth",
        "Choose from in-demand certification tracks and connect with our team for registration, counselling, and preparation support."
      ) +
      '<div class="exam-grid exam-grid-3">' +
      certificationPrograms
        .map((item) => {
          const slug = item[0]
            ...
            .replace(/\s+/g, "-");
          return (
            '<article class="glass card reveal exam-cert-card"><div class="exam-icon-badge exam-cert-icon-badge">' +
            certificationProgramIcon(item[0]) +
            "</div><h3>" +
            item[0] +
            '</h3><p class="muted">' +
            item[1] +
            '</p><a class="btn btn-secondary" href="exam.html?slug=' +
            slug +
            '">View Separate Page</a></article>'
          );
        })
        .join("") +
      "</div>" +
      '<article class="glass card reveal exam-form-card exam-form-card-inline" id="exam-enquiry"><div class="exam-form-card-header"><div><span class="eyebrow">Exam Enquiry</span><h3>Enquire Now</h3><p class="muted">Share your preferred certification and our team will help you with the next steps.</p></div><div class="exam-icon-badge">' +
      examModuleIcon("enquiry") +
      "</div></div>" +
      enquiryForm(
        "globalCertificationForm",
  ...
  function sendEnquiryMail(data) {
    ...
    window.location.href =
      ...
      "&subject=" +
      encodeURIComponent("Exam Enquiry - " + examType) +
      "&body=" +
  ...
  function examDomainPage() {
    const slug =
      new URLSearchParams(window.location.search).get("slug") || "languagecert";
    const detail = examDomainDetails[slug];
    if (!detail) {
      app.innerHTML =
        header(false) +
        '<main class="empty-state"><div><h1 class="gradient-text">Exam page not found</h1><p class="lead">The requested exam page could not be found.</p><a class="btn btn-primary" href="exam.html">Back to Exams</a></div></main>' +
        footer() +
        whatsappFloat() +
        googleFeedbackFloat() +
        feedbackModal() +
    ...
    app.innerHTML =
      ...
      detail.levels
        ...
        .join("") +
      "</div>" +
      '<div class="detail-actions"><a class="btn btn-primary" href="#exam-detail-form">Apply for This Exam</a><a class="btn btn-secondary" href="' +
      (detail.backHref || "exam.html") +
      '">Back to Exam Hub</a></div>' +
      "</div>" +
      '<div class="exam-panel-art exam-panel-art-banner"><img src="' +
      examBannerImage +
      '" alt="Indian certification banner" /><p>' +
      detail.intro +
      "</p></div>" +
      "</div>" +
      "</div></section>" +
      ...
      sectionHeader(
        "Exam Overview",
        detail.overviewTitle || "Detailed Listing",
        detail.overviewIntro ||
          "Each exam domain is now separated into its own page while keeping the same application UI and color language."
      ) +
      '<div class="exam-grid exam-grid-3">' +
      '<article class="glass card reveal exam-cert-card"><h3>Exam Levels</h3><div class="exam-points-list">' +
      detail.levels
        .map(function (level) {
          return (
            "<div><strong>" +
            level +
            '</strong><p class="muted">Available pathway supported through our exam guidance flow.</p></div>'
          );
        })
        .join("") +
      "</div></article>" +
      '<article class="glass card reveal exam-cert-card"><h3>Benefits Provided</h3><div class="exam-points-list">' +
      detail.benefits
        .map(function (item) {
        ...
        .join("") +
      "</div></article>" +
      '<article class="glass card reveal exam-cert-card"><h3>Additional Details</h3><div class="exam-points-list">' +
      detail.extras
        .map(function (item) {
          return '<div><p class="muted">' + item + "</p></div>";
        })
      ...
      sectionHeader(
        "Different Rounds",
        detail.roundsTitle || "How the Journey Is Organized",
        detail.roundsIntro ||
          "The flow below separates the typical stages involved before the final certification attempt."
      ) +
      '<div class="exam-grid exam-grid-2">' +
      detail.rounds
        .map(function (round, index) {
          return (
            '<article class="glass card reveal exam-partner-card"><div class="exam-badge">Round ' +
            (index + 1) +
            "</div><h3>" +
            round[0] +
            '</h3><p class="muted">' +
      ...
      '<article class="glass card reveal exam-form-card exam-form-card-inline"><div class="exam-form-card-header"><div><span class="eyebrow">Apply Now</span><h3>' +
      detail.title +
      '</h3><p class="muted">Submit your details to prepare an enquiry email to both you and our HR team.</p></div><div class="exam-icon-badge' +
      (slug === "languagecert" ? " exam-logo-badge" : "") +
      '">' +
      (slug === "languagecert"
        ? examModuleIcon("languagecert")
        : examModuleIcon("enquiry")) +
  ...
  function examFeedbackSection() {
    return (
      '<section class="section exam-shell section-muted" id="exam-feedback"><div class="container">' +
      sectionHeader(
        "Feedback",
        "Stay Connected and Share Your Experience",
        "Follow iLogic Tech on social media, then send us your feedback through a simple verified form."
      ) +
      ...
      '<label><span>Email</span><input type="email" name="email" placeholder="Enter your email" required /></label>' +
      "</div>" +
      '<div class="exam-rating-block"><span class="exam-rating-label">Rating</span><div class="exam-feedback-stars" role="radiogroup" aria-label="Rate your experience">' +
      [1, 2, 3, 4, 5]
        .map(
          (value) =>
            '<button class="exam-feedback-star" type="button" data-exam-feedback-rating="' +
            value +
            '" role="radio" aria-checked="false" aria-label="' +
            value +
            " star" +
            (value > 1 ? "s" : "") +
            '"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m12 3.8 2.6 5.3 5.9.9-4.2 4.1 1 5.8-5.3-2.8-5.3 2.8 1-5.8-4.2-4.1 5.9-.9L12 3.8Z"/></svg></button>'
        )
        .join("") +
      '</div><input type="hidden" id="examFeedbackRating" value="" /></div>' +
  ...
  function buildWhatsAppUrl(phone, name) {
    return (
      ...
      phone +
      "?text=" +
      encodeURIComponent(buildWhatsAppPrefill(name))
    );
  }
  ...
  function topContactBar() {
    return (
      '<div class="header-topbar"><div class="container"><div class="header-topbar-inner"><div class="topbar-enquiry"><span class="topbar-icon topbar-whatsapp-icon" aria-hidden="true">' +
      topbarWhatsAppIcon() +
      '</span><span class="topbar-enquiry-label">Enquiry Now:</span><div class="topbar-phone-links">' +
      enquiryNumbers
        .map(function (item, index) {
          return (
            '<a class="topbar-phone" href="' +
            buildWhatsAppUrl(item.whatsapp, "") +
            '" data-whatsapp-link data-phone="' +
            item.whatsapp +
            '" aria-label="Open WhatsApp chat with ' +
            item.label +
            '">' +
            item.label +
            "</a>" +
            (index < enquiryNumbers.length - 1
  ...
  function mapEmbedUrl(mapUrl) {
    ...
    if (match && match[1])
      return "https://www.google.com/maps?q=" + match[1] + "&z=15&output=embed";
  ...
  function header(isHome) {
    return (
      ...
      topContactBar() +
      '<div class="container"><div class="site-header-inner"><a class="brand" href="index.html#home"><img src="' +
      logo +
      '" alt="iLogic Tech" /></a><nav class="nav">' +
      navLinks
        .map(
          (item) =>
            '<div class="nav-item" data-nav-countries="' +
            (item.countries || ["SG", "IN"]).join(",") +
        ...
        .join("") +
      '</nav><div class="desktop-actions header-actions">' +
      countryToggle("country-toggle-desktop") +
      '</div><button class="menu-toggle" id="menuToggle" aria-label="Open menu" aria-expanded="false" aria-controls="mobileNav"><span></span><span></span><span></span></button></div><div class="mobile-nav" id="mobileNav">' +
      countryToggle("country-toggle-mobile") +
      navLinks
        .map(
          (item) =>
            '<div class="mobile-item" data-nav-countries="' +
            (item.countries || ["SG", "IN"]).join(",") +
            '">' +
            (item.submenu
              ? '<button class="mobile-link" type="button" aria-expanded="false"><span>' +
                item.label +
                '</span><span class="caret" aria-hidden="true"></span></button><div class="mobile-submenu">' +
                item.submenu
                  .map((sub) => '<a href="' + sub[1] + '">' + sub[0] + "</a>")
                  .join("") +
                "</div>"
  ...
  function testimonialCardMarkup(item) {
    return (
      ...
      '<div class="review-header"><div class="avatar-badge">' +
      avatarInitials(item.name) +
      '</div><div><h3 style="margin:0;">' +
      escapeHtml(item.name) +
      '</h3><p class="muted" style="margin:0.2rem 0 0;">' +
      escapeHtml(item.company) +
      " | " +
      escapeHtml(item.role) +
      "</p></div></div>" +
      '<p class="stars">' +
      Array((item.rating || 0) + 1).join("★") +
      '</p><p class="muted">' +
  ...
  function feedbackModal() {
    return (
      ...
      "</div>" +
      '<div class="feedback-stars" id="feedbackStars" role="radiogroup" aria-label="Rate your experience">' +
      [1, 2, 3, 4, 5]
        .map(
          (value) =>
            '<button class="feedback-star" type="button" data-feedback-rating="' +
            value +
            '" role="radio" aria-checked="false" aria-label="' +
            value +
            " star" +
  ...
  function hiringWidget() {
    return (
      '<div class="hiring-widget-wrap" id="hiringWidgetWrap">' +
  ...
  function internshipChatbotModal() {
    return (
      '<div class="hiring-chatbot" id="hiringChatbot" aria-hidden="true">' +
      ...
      internshipTracks
        .map(
          (track) =>
            '<button type="button" data-hiring-role="' +
            track.title +
            '">' +
            track.title +
            "</button>"
  ...
  function branchPhoneMarkup(phone) {
    const phones = String(phone || "")
      ...
      .filter(Boolean);
    return (
      '<p class="branch-phone"><strong class="branch-phone-label">Phone:</strong> <span class="branch-phone-list">' +
      phones
        .map(
          (item, index) =>
            '<span class="branch-phone-number">' +
            item +
            "</span>" +
            (index < phones.length - 1
              ? '<span class="branch-phone-separator" aria-hidden="true">,</span>'
              : "")
        )
        .join("") +
      "</span></p>"
  ...
  function branchSection() {
    return (
      '<section class="section section-muted" id="branches" data-country-display="SG,IN"><div class="container">' +
      sectionHeader(
        "Our Branches",
        "Our Branches",
      ...
      branches
        .map(
          (item) =>
            '<article class="glass branch-card reveal">' +
            (item.map
              ? '<a class="branch-map-preview" href="' +
                item.map +
                '" target="_blank" rel="noreferrer noopener" aria-label="Open live map for ' +
                item.title +
                '" title="Open live map for ' +
                item.title +
                '">' +
                '<iframe src="' +
                mapEmbedUrl(item.map) +
                '" loading="lazy" referrerpolicy="no-referrer-when-downgrade" aria-hidden="true" tabindex="-1"></iframe>' +
                '<span class="branch-map-overlay"><span class="branch-map-badge">' +
                contactIcon("location") +
                "<span>Open Live Map</span></span></span>" +
                "</a>"
              : "") +
  ...
  function contactSection() {
    return (
      ...
      sectionHeader(
        "Contact Us",
        "Get In Touch",
        "Ready to transform your business with cutting-edge technology? Let us talk about how we can help."
      ) +
      '<div class="contact-grid"><div class="contact-stack"><div class="glass card reveal"><div class="contact-item"><div class="contact-icon" aria-hidden="true">' +
      contactIcon("location") +
      '</div><div><strong>Contact Details</strong></div></div></div><div class="glass card reveal"><div class="contact-item"><div class="contact-icon" aria-hidden="true">' +
      contactIcon("phone") +
      '</div><div><strong>Phone</strong><p class="muted">+65 90175062 / +91 72000 05541</p></div></div></div><div class="glass card reveal"><div class="contact-item"><div class="contact-icon" aria-hidden="true">' +
      contactIcon("email") +
      '</div><div><strong>Email</strong><p class="muted">info@ilogic.com.sg<br>hr@ilogic.com.sg</p></div></div></div><div class="glass card reveal"><div class="contact-item"><div class="contact-icon" aria-hidden="true">' +
      contactIcon("web") +
      '</div><div><strong>Website</strong><p class="muted">www.ilogic.com.sg</p></div></div></div></div><div class="glass card reveal"><form class="contact-form" id="contactForm"><h3 class="gradient-text" style="font-family:Space Grotesk, sans-serif; margin:0;">Send us a message</h3><div class="form-grid"><label>Full Name<input name="name" required /></label><label>Email<input type="email" name="email" required /></label></div><div class="form-grid"><label>Phone<input name="phone" required /></label><label>Subject<input name="subject" value="New enquiry" required /></label></div><label>Message<textarea name="message" required></textarea></label><button class="btn btn-primary" type="submit">Send Message</button></form></div></div></div></section>'
    );
  }
  ...
  function resolveSolutionStats(stats, slug) {
    ...
    return stats.map(function (item, index) {
      ...
      let value = Math.floor(
        range[0] + Math.random() * (range[1] - range[0] + 1)
      );
  ...
  function solutionStats(stats, slug) {
    ...
    return (
      '<div class="solution-metric-grid">' +
      resolved
        .map(
          (item) =>
            '<article class="glass solution-metric-card reveal"><strong><span data-solution-stat="' +
            item.value +
            '">0</span></strong><span>' +
            item.label +
            "</span></article>"
  ...
  function solutionFaqs(items) {
    return (
      ...
      items
        .map(
          (item) =>
            '<article class="glass detail-card reveal solution-faq-card"><h3>' +
            item[0] +
            '</h3><p class="muted">' +
            item[1] +
            "</p></article>"
    ...
    return detail.sections
      .map((section) => {
        const content = section.items
          ? solutionFeatureList(section.items)
          : section.faqs
            ? solutionFaqs(section.faqs)
            : section.body
                .map((text) => '<p class="lead">' + text + "</p>")
                .join("");
        return (
          '<section class="section ' +
          (section.faqs ? "" : "section-muted") +
          '"><div class="container"><div class="solution-section-block reveal"><div class="solution-section-header"><span class="eyebrow">' +
          detail.eyebrow +
          '</span><h2 class="gradient-text">' +
          section.title +
          '</h2></div><div class="solution-section-content">' +
          content +
          "</div></div></div></section>"
        );
      })
  ...
  function solutionSummaryCard(item, detail) {
    const firstItems = detail.sections.find(
      (section) => section.items && section.items.length
    );
    const quickPoints = firstItems ? firstItems.items.slice(0, 5) : item[3];
    return (
      '<article class="glass detail-card reveal solution-summary-card"><p class="solution-summary-kicker">Solution Snapshot</p><h3>' +
      item[1] +
      '</h3><p class="muted">' +
      item[4] +
      '</p><div class="tag-list">' +
      item[3].map((tag) => "<span>" + tag + "</span>").join("") +
      "</div>" +
      solutionFeatureList(quickPoints) +
      "</article>"
    );
  }
  ...
  function solutionPageContent(item, detail) {
    const hasMedia = Boolean(
      (detail.video && detail.video.src) || (detail.image && detail.image.src)
    );
    return (
      header(false) +
      '<main class="solution-detail-page' +
      (hasMedia ? " has-video" : " no-video") +
      '">' +
      '<section class="detail-hero solution-hero-shell"><div class="container">' +
      '<div class="solution-page-header reveal"><span class="eyebrow">' +
      detail.eyebrow +
      '</span><h1 class="gradient-text">' +
      detail.headline +
      '</h1><p class="lead">' +
      detail.intro +
      '</p><div class="tag-list">' +
      item[3].map((tag) => "<span>" + tag + "</span>").join("") +
      '</div><div class="detail-actions" style="margin-top:1.5rem;"><a class="btn btn-primary" href="index.html#contact">Request a Demo</a><a class="btn btn-secondary" href="index.html#solutions">Back to Solutions</a></div></div>' +
      (hasMedia
        ? '<div class="solution-hero-grid">' +
          solutionVideoPlayer(item, detail) +
          solutionSummaryCard(item, detail) +
          "</div>"
        : '<div class="solution-content-hero">' +
          solutionSummaryCard(item, detail) +
          "</div>") +
      solutionStats(detail.stats || [], item[0]) +
      "</div></section>" +
      solutionSections(detail) +
      '<section class="section"><div class="container"><article class="glass detail-card reveal solution-cta-panel"><span class="eyebrow">Get Started</span><h2 class="gradient-text">' +
      detail.ctaTitle +
      '</h2><p class="lead">' +
      detail.ctaText +
      '</p><div class="detail-actions"><a class="btn btn-primary" href="index.html#contact">Contact Our Team</a><a class="btn btn-secondary" href="mailto:info@ilogic.com.sg">info@ilogic.com.sg</a></div></article></div></section>' +
      "</main>" +
      footer() +
      whatsappFloat() +
      googleFeedbackFloat() +
  ...
  function homePage() {
    app.innerHTML =
      ...
      [
        ...
        .map(
          (item) =>
            '<article class="glass card"><div class="icon-badge">' +
            aboutIcon(item[0]) +
            "</div><h3>" +
            item[0] +
            '</h3><p class="muted">' +
        ...
        .join("") +
      "</div></div></div></section>" +
      '<section class="section" id="products" data-country-display="SG"><div class="container">' +
      sectionHeader("Our Products", "Product Lineup", "") +
      '<div class="grid-4">' +
      products
        .map(
          (item) =>
            '<article class="glass card reveal"><div class="product-media"><img src="' +
            item[2] +
            '" alt="' +
            item[1] +
            '" /></div><div class="product-card-body"><h3>' +
            item[1] +
            '</h3><p class="muted card-summary">' +
            item[3] +
            '</p><div class="card-details"><div class="tag-list">' +
            item[4].map((feature) => "<span>" + feature + "</span>").join("") +
            "</div>" +
            (item[5]
              ? '<p class="muted card-description">' + item[5] + "</p>"
              : "") +
            '<a class="btn btn-secondary" href="project.html?slug=' +
            item[0] +
            '">View More Details</a></div></div></article>'
        )
        .join("") +
      "</div></div></section>" +
      '<section class="section section-muted" id="services" data-country-display="SG"><div class="container">' +
      sectionHeader(
        "Our Services",
        "Comprehensive Services",
        "Technology solutions tailored to your industry needs."
      ) +
      '<div class="grid-3">' +
      services
        .map(
          (item) =>
            '<article class="glass card reveal service-card"><div class="icon-badge service-icon-badge">' +
            serviceIcon(item[0]) +
            "</div><h3>" +
            item[1] +
            '</h3><p class="muted">' +
            item[2] +
            '</p><ul class="service-points">' +
            item[3].map((feature) => "<li>" + feature + "</li>").join("") +
            '</ul><a class="btn btn-secondary" href="' +
            serviceCardHref(item[0]) +
            '">View More Details</a></article>'
        )
        .join("") +
      "</div></div></section>" +
      '<section class="section" id="solutions" data-country-display="SG"><div class="container">' +
      sectionHeader(
        "Our Solutions",
        "Business Applications",
        "Explore our innovative applications and industry-focused software."
      ) +
      '<div class="grid-4">' +
      solutions
        .map(
          (item) =>
            '<article class="glass card reveal solution-card"><div class="solution-media"><img src="' +
            item[5] +
            '" alt="' +
            item[1] +
            '" loading="lazy" /></div><div class="solution-title"><div class="solution-title-pane"><h3>' +
            item[1] +
            '</h3></div></div><div class="solution-overlay"><div class="solution-overlay-pane"><h3>' +
            item[1] +
            '</h3><p class="muted">' +
            item[2] +
            '</p><div class="tag-list">' +
            item[3].map((feature) => "<span>" + feature + "</span>").join("") +
            '</div><a class="btn btn-secondary" href="solution.html?slug=' +
            item[0] +
            '">View Project</a></div></div></article>'
        )
        .join("") +
      "</div></div></section>" +
      '<section class="section section-muted" id="clients" data-country-display="SG"><div class="container">' +
      sectionHeader(
        "Our Clients",
        "Trusted by Leading Brands",
        "Proud to partner with businesses across the globe."
      ) +
      [clientLogos.slice(0, 7), clientLogos.slice(7, 13), clientLogos.slice(13)]
        .map(
          (row, idx) =>
            '<div class="marquee ' +
            (idx === 1 ? "reverse" : "") +
            ...
            row
              ...
              .map(
                (path) =>
                  '<div class="logo-card glass"><img src="' +
                  path +
                  '" alt="Client logo" /></div>'
              )
              .join("") +
        ...
        .join("") +
      "</div></section>" +
      '<section class="section" id="partners" data-country-display="SG"><div class="container">' +
      sectionHeader(
        "Our Partners",
        "Strategic Partners",
      ...
      partners
        .map(
          (item) =>
            '<div class="glass card reveal logo-card"><img src="' +
            item +
            '" alt="Partner logo" /></div>'
        )
        .join("") +
      "</div></div></section>" +
      '<section class="section section-muted" id="team" data-country-display="IN"><div class="container">' +
      sectionHeader(
        "Leadership",
        "Our Leadership",
        "Visionary leaders driving innovation and excellence."
      ) +
      '<div class="grid-2" style="max-width:38rem;margin:0 auto;">' +
      team
        .map(
          (item) =>
            '<article class="glass card reveal team-card"><div class="team-photo"><img src="' +
            item.image +
            '" alt="' +
            item.name +
            '" /></div><p class="team-role">' +
            item.role +
            '</p><h3 class="team-signature">' +
            item.name +
            '</h3><p class="muted team-title">' +
            item.title +
            "</p></article>"
        )
        .join("") +
      "</div></div></section>" +
      '<section class="section" id="gallery" data-country-display="IN"><div class="container">' +
      sectionHeader(
        "Moments",
        "Life at iLogic Tech",
        "A glimpse into our workspace, events, and achievements."
      ) +
      '<div class="gallery-folder-grid">' +
      galleryCards(galleryCollections) +
      "</div></div></section>" +
      '<section class="section section-muted" id="reviews"><div class="container">' +
      sectionHeader(
        "Testimonials",
        "What Our Clients Say",
        "Top reviews from businesses we have supported."
      ) +
      '<div class="grid-3" id="testimonialsGrid">' +
      defaultTestimonials.map(testimonialCardMarkup).join("") +
      "</div></div></section>" +
      branchSection() +
      contactSection() +
      "</main>" +
  ...
  function refineHomeHero() {
    ...
    const embeddedSubline = heroHeading
      ? heroHeading.querySelector(".subline")
      : null;
    if (heroHeading) {
      heroHeading.innerHTML =
        '<span class="gradient-text">Integrated POS Systems & IT Solutions for Businesses in Singapore and India</span>';
    }
    if (
      heroHeading &&
      embeddedSubline &&
      !hero.querySelector(".hero-copy > .subline")
    ) {
  ...
  function refineAboutContent() {
    ...
    aboutColumn.innerHTML =
      ...
      '<img src="' +
      aboutImage +
      '" alt="Empowering businesses with intelligent technology" loading="lazy" />' +
      "</div>" +
      "</div>" +
      "</article>" +
      '<article class="glass about-feature-panel">' +
      ...
      list([
        "Streamline your business operations with reliable POS system implementation, deployment, integration and ongoing support tailored to your industry requirements.",
        "Ensure seamless technology adoption through expert planning, installation, configuration, data migration and system optimization services.",
        "Develop scalable web, mobile and enterprise applications that automate processes, improve productivity and support long-term business growth.",
        "Keep your systems running smoothly with proactive monitoring, troubleshooting, software updates, cybersecurity support and dedicated technical assistance.",
      ]) +
      '</div><div class="about-detail-media"><img src="' +
      aboutExpertiseImage +
      '" alt="Our Expertise" loading="lazy" /></div></article>' +
      ...
      list([
        "Identify the right POS strategy and technology solutions to meet your operational goals and business requirements.",
        "Professional installation, configuration, and integration of POS systems for reliable and efficient performance.",
        "Securely transfer business data, inventory records, customer information, and transaction history with minimal downtime.",
        "Comprehensive user training and onboarding programs to help your team maximize productivity and confidently use the POS system.",
      ]) +
      '</div><div class="about-detail-media"><img src="' +
      aboutTrainingImage +
      '" alt="POS Implementation and Support" loading="lazy" /></div></article>' +
      '<div class="about-detail-grid">' +
      '<article class="glass about-feature-panel">' +
      '<div class="about-feature-copy">' +
      ...
      list([
        "Earn internationally recognized English language qualifications trusted by educational institutions, employers, and organizations worldwide.",
        "Enhance your communication skills and strengthen your career prospects with certifications that demonstrate English proficiency in professional environments.",
        "Benefit from flexible, convenient, and learner-focused certification pathways designed to meet the needs of students, job seekers, and working professionals.",
      ]) +
      '</div><div class="about-detail-media"><img src="' +
      aboutPartnerImage +
      '" alt="Official LanguageCert Partner" loading="lazy" /></div></article>' +
      '<article class="glass about-feature-panel">' +
      '<div class="about-feature-copy">' +
      ...
      list([
        "Design, implement, and manage secure network infrastructures with advanced security measures to protect business-critical data and ensure reliable connectivity.",
        "Optimize IT performance through strategic infrastructure planning, system monitoring, disaster recovery, and business continuity solutions that minimize downtime and maximize efficiency.",
        "Gain practical industry experience through hands-on technical training programs and internship opportunities designed to bridge the gap between learning and real-world application.",
        "Equip students and professionals with in-demand technology skills, certifications, and career-focused training aligned with current industry standards and emerging technologies.",
      ]) +
      '</div><div class="about-detail-media"><img src="' +
      aboutInfrastructureImage +
      '" alt="Networking, Infrastructure and Training" loading="lazy" /></div>' +
      "</div></article>" +
      "</div>";
  ...
  function detailPage(kind) {
    ...
    if (!item) {
      app.innerHTML =
        header(false) +
        '<main class="empty-state"><div><h1 class="gradient-text">' +
        kind +
        ' not found</h1><p class="lead">The requested page could not be found.</p><a class="btn btn-primary" href="index.html">Back to Home</a></div></main>' +
        footer() +
        whatsappFloat() +
        googleFeedbackFloat() +
        feedbackModal() +
    ...
    const media =
      kind === "project"
        ? '<div class="detail-media detail-media-plain reveal"><img src="' +
          item[2] +
          '" alt="' +
          item[1] +
          '" /></div>'
    ...
    if (kind === "service") {
      ...
      app.innerHTML =
        ...
        '<div class="detail-copy reveal"><span class="eyebrow">Our Services</span><h1 class="gradient-text">' +
        experience.heroTitle +
        '</h1><p class="lead">' +
        experience.heroText +
        '</p><div class="tag-list">' +
        tags.map((tag) => "<span>" + tag + "</span>").join("") +
        '</div><div class="detail-actions" style="margin-top:1.5rem;"><a class="btn btn-primary" href="' +
        experience.primaryHref +
        '">' +
        experience.primaryCta +
        '</a><a class="btn btn-ghost" href="index.html#services">Back to Services</a></div></div>' +
        '<article class="glass detail-card reveal service-summary-card"><div class="icon-badge service-icon-badge">' +
        serviceIcon(item[0]) +
        '</div><h3 class="gradient-text">Service Snapshot</h3><p class="muted">' +
        body[0] +
        '</p><div class="service-detail-meta"><strong>Best Fit</strong><p class="muted">' +
        detail.idealFor +
        "</p></div></article>" +
        "</div>" +
        ...
        "</div></section>" +
        '<section class="section"><div class="container"><article class="glass detail-card reveal service-cta-card"><span class="eyebrow">Start Now</span><h2 class="gradient-text">' +
        experience.ctaTitle +
        '</h2><p class="lead">' +
        experience.ctaText +
        '</p><div class="detail-actions"><a class="btn btn-primary" href="' +
        experience.primaryHref +
        '">' +
        experience.primaryCta +
        '</a><a class="btn btn-secondary" href="' +
        experience.secondaryHref +
        '">' +
        experience.secondaryCta +
        '</a></div><div class="service-detail-grid"><article class="glass detail-card reveal"><h3 class="gradient-text">What We Deliver</h3>' +
        list(detail.deliverables) +
        '</article><article class="glass detail-card reveal"><h3 class="gradient-text">Delivery Approach</h3>' +
        list(detail.process) +
        '</article><article class="glass detail-card reveal"><h3 class="gradient-text">Business Outcomes</h3>' +
        list(detail.outcomes) +
        "</article></div></article></div></section>" +
        "</main>" +
        footer() +
        whatsappFloat() +
        googleFeedbackFloat() +
    ...
    if (kind === "solution") {
      const detail = solutionExperienceDetails[item[0]] || {
        ...
        ctaText:
          "Talk to our team to see how this solution can be tailored to your operations.",
      };
    ...
    const productDetail =
      kind === "project"
        ? productDetailPoints[item[0]] || {
            highlights: [
              "Designed for smooth day-to-day business usage",
              "Supports faster service and staff efficiency",
              "Built for dependable business operations",
              "Easy to use within modern retail workflows",
              "Helps improve consistency and service quality",
            ],
            overview: [
              "Built for reliable day-to-day business operations",
              "Supports efficient transaction processing",
              "Designed for smooth user interaction",
              "Suitable for modern retail and service environments",
            ],
            benefits: [
    ...
    app.innerHTML =
      ...
      (kind === "project"
        ? '<div class="detail-highlight-list">' +
          list(productDetail.highlights.slice(0, 5)) +
          "</div>"
        : "") +
      '<div class="tag-list">' +
      tags.map((tag) => "<span>" + tag + "</span>").join("") +
      ...
      (kind === "project"
        ? list(productDetail.benefits.slice(0, 5))
        : list([
  ...
  function careerPage() {
    app.innerHTML =
      ...
      sectionHeader(
        ...
        "Explore the opportunities and find the role that's right for you.",
        ""
      ) +
      '<div class="grid-3 jobs-grid reveal">' +
  ...
  function internshipPage() {
    ...
    const tracks = [
      {
        title: "Full Stack Development",
        desc: "Master frontend and backend development using modern frameworks and technologies.",
        badges: [
          "React",
          "Node.js",
          "Express",
      ...
      },
      {
        ...
        desc: "Build scalable mobile applications for Android and iOS platforms.",
        badges: [
          "React Native",
          "Flutter",
          "Swift",
      ...
      },
      {
        ...
        desc: "Develop intelligent solutions using AI, machine learning, and data analytics.",
        badges: [
          "Python",
          "TensorFlow",
          "PyTorch",
      ...
      {
        title: "Cloud & DevOps",
        desc: "Learn cloud platforms, DevOps practices, and deployment automation.",
        badges: [
          "AWS",
          "Azure",
          "Docker",
      ...
      {
        title: "Cybersecurity",
        desc: "Protect digital systems through cybersecurity and network security practices.",
        badges: [
          "Kali Linux",
          "Wireshark",
          "Burp Suite",
      ...
      {
        title: "UI/UX Design",
        desc: "Create intuitive, user-friendly interfaces with modern design principles.",
        badges: ["Figma", "Adobe XD", "Sketch", "InVision", "Miro", "Zeplin"],
        weeks: "8 Weeks",
      },
    ];
    ...
    const testimonials = [
      {
        quote:
          "My time at iLogic Tech helped me grow professionally and personally. Thank you to the team for the guidance and hands-on learning!",
        name: "Wafiya Banu. A",
        role: "Mobile Developer",
      },
      {
        quote:
          "The mentorship and live projects gave me the confidence to walk into interviews and actually talk about real work I had shipped.",
        name: "Arjun Kumar. S",
        role: "Full Stack Developer",
      },
      {
        quote:
          "From zero portfolio to a placement offer in a few months — the structured learning path made all the difference for me.",
    ...
    const trackCard = (t) => `
    <article class="glass card track-card">
      <h3>${t.title}</h3>
      <p class="muted">${t.desc}</p>
      <div class="badge-grid">
        ${t.badges.map((b) => `<span class="tech-badge">${b}</span>`).join("")}
      </div>
      <p class="muted track-duration">Duration: <strong>${t.weeks}</strong></p>
      <a class="btn btn-secondary" href="index.html#contact" style="margin-top:auto;">Apply Now</a>
    </article>`;

    const testimonialSlide = (t, i) => `
    <div class="testimonial-slide${i === 0 ? " is-active" : ""}" data-slide="${i}">
      <article class="glass card">
        <p class="lead" style="font-style:italic;">"${t.quote}"</p>
    ...
    const testimonialDot = (i) =>
      `<button class="slider-dot${i === 0 ? " is-active" : ""}" data-dot="${i}" onclick="internshipTestimonialGoTo(${i})" aria-label="Show testimonial ${i + 1}"></button>`;

    app.innerHTML = `
    <style id="internship-page-styles">
      .internship-hero-ctas { display:flex; gap:1rem; justify-content:center; flex-wrap:wrap; margin-bottom:2.5rem; }
      .stat-card { transition: transform .25s ease, box-shadow .25s ease; padding:2rem 1rem; }
      .stat-card:hover { transform: translateY(-6px); box-shadow: 0 12px 30px rgba(0,0,0,0.18); }
      .stat-card strong { font-size:2.6rem; display:block; line-height:1.2; }

      .overview-icon { font-size:1.8rem; display:block; margin-bottom:0.75rem; }
      .overview-list { margin:0.75rem 0 0; padding-left:1.2rem; color:var(--text-muted); font-size:0.92rem; }
      .overview-list li { margin-bottom:0.35rem; }

      .badge-grid { display:flex; flex-wrap:wrap; gap:0.5rem; margin:1rem 0; }
      .tech-badge { background:rgba(255,255,255,0.08); border:1px solid rgba(255,255,255,0.15); padding:0.3rem 0.75rem; border-radius:999px; font-size:0.82rem; color:var(--text-muted); }
      .track-card { display:flex; flex-direction:column; }
      .track-duration { font-weight:600; margin-top:0.25rem; }

      .timeline-horizontal { display:flex; align-items:stretch; justify-content:space-between; gap:0.5rem; flex-wrap:wrap; }
      .timeline-step { flex:1 1 200px; text-align:center; position:relative; }
      .timeline-arrow { display:flex; align-items:center; justify-content:center; font-size:1.6rem; color:var(--text-muted); flex:0 0 auto; }
      @media (max-width: 800px) {
        .timeline-horizontal { flex-direction:column; }
        .timeline-arrow { transform:rotate(90deg); }
      }

      .benefit-icon { font-size:1.9rem; display:block; margin-bottom:0.6rem; }

      .checklist { list-style:none; padding:0; margin:0; display:grid; gap:0.9rem; max-width:36rem; margin:0 auto; }
      .checklist-item { display:flex; align-items:flex-start; gap:0.75rem; }
      .checklist-item .check-mark { color:#2ecc71; font-weight:700; font-size:1.1rem; line-height:1.5; }

      .testimonial-slider { position:relative; max-width:40rem; margin:0 auto; }
      .testimonial-slide { display:none; }
      .testimonial-slide.is-active { display:block; }
      .slider-controls { display:flex; align-items:center; justify-content:center; gap:1.5rem; margin-top:1.25rem; }
      .slider-btn { background:rgba(255,255,255,0.08); border:1px solid rgba(255,255,255,0.15); color:inherit; width:2.5rem; height:2.5rem; border-radius:50%; cursor:pointer; font-size:1.1rem; }
      .slider-btn:hover { background:rgba(255,255,255,0.18); }
      .slider-dots { display:flex; gap:0.5rem; }
      .slider-dot { width:0.6rem; height:0.6rem; border-radius:50%; border:none; background:rgba(255,255,255,0.25); cursor:pointer; padding:0; }
      .slider-dot.is-active { background:#fff; }
    </style>

    ${header(false)}
    <main>
      <section class="section hero internship-hero">
        <div class="container">
          <div class="hero-copy reveal is-visible career-hero-copy" style="max-width:56rem;margin:3rem auto 0;text-align:center;">
            <span class="eyebrow">Internship Program</span>
            <h1 class="gradient-text career-single-line">Launch Your IT Career with Real-World Experience</h1>
            <p class="muted" style="max-width:700px;margin:20px auto 30px;">Gain practical experience through live industry projects, expert mentorship and career-focused learning.</p>
          
          </div>
          <div class="grid-3 stats-grid reveal">
            <article class="glass card stat-card">
              <center>
                <strong id="internCounter">0</strong>
                <br><span>Interns Trained</span>
              </center>
            </article>
            <article class="glass card stat-card">
              <center>
                <strong id="placementCounter">0%</strong>
                <br><span>Placement Rate</span>
              </center>
            </article>
            <article class="glass card stat-card">
              <center>
                <strong id="weekCounter">0</strong>
                <br><span>Week Program</span>
              </center>
            </article>
          </div>
        </div>
      ...
      <section class="section section-muted">
        <div class="container">
          ${sectionHeader("Program Overview", "Launch Your IT Career with Industry-Focused Internships", "")}
          <div class="grid-2 content-grid reveal">
            <article class="glass card">
          ...
          <div class="grid-2 content-grid reveal" style="margin-top:2rem;">
            <article class="glass card">
              <span class="overview-icon">📜</span>
              ...
              <ul class="overview-list">
                ...
                <li>Project Completion Badge</li>
      ...
      <section class="section">
        <div class="container">
          ${sectionHeader("Internship Tracks", "Choose Your Tech Specialization", "")}
          <div class="grid-3 reveal">
      ...
      <section class="section section-muted">
        <div class="container">
          ${sectionHeader("Learning Journey", "Structured learning path designed for maximum skill development", "")}
          <div class="timeline-horizontal reveal">
            <div class="timeline-step glass card"><div class="step-badge">1</div><h3>Orientation</h3></div>
            <div class="timeline-arrow">→</div>
            <div class="timeline-step glass card"><div class="step-badge">2</div><h3>Technical Training</h3></div>
            <div class="timeline-arrow">→</div>
            <div class="timeline-step glass card"><div class="step-badge">3</div><h3>Live Projects</h3></div>
            <div class="timeline-arrow">→</div>
            <div class="timeline-step glass card"><div class="step-badge">4</div><h3>Portfolio + Certificate</h3></div>
          </div>
        </div>
      </section>
      ...
      <section class="section">
        <div class="container">
          ${sectionHeader("Internship Benefits", "Career Support That Moves You Forward", "")}
          <div class="grid-3 reveal">
            <article class="glass card"><span class="benefit-icon">💰</span><h3>Stipend</h3><p class="muted">Monthly stipend to support your internship and learning experience.</p></article>
            <article class="glass card"><span class="benefit-icon">🏆</span><h3>Certificate</h3><p class="muted">Earn recognized certifications and enhance your professional profile.</p></article>
            <article class="glass card"><span class="benefit-icon">💻</span><h3>Live Projects</h3><p class="muted">Work on live projects using modern technologies and industry tools.</p></article>
            <article class="glass card"><span class="benefit-icon">👨‍🏫</span><h3>Mentorship</h3><p class="muted">Learn from experienced professionals with personalized guidance.</p></article>
            <article class="glass card"><span class="benefit-icon">🤝</span><h3>Placement Support</h3><p class="muted">Job placement assistance, interview preparation, and career guidance.</p></article>
            <article class="glass card"><span class="benefit-icon">🌐</span><h3>Networking</h3><p class="muted">Connect with industry professionals and expand your network.</p></article>
          </div>
        </div>
      </section>
      ...
      <section class="section section-muted">
        <div class="container">
          ${sectionHeader("Program Requirements", "What We Look for in Future Interns", "")}
          <ul class="checklist reveal">
            <li class="checklist-item"><span class="check-mark">✔</span><span>Computer Science / IT Background</span></li>
            <li class="checklist-item"><span class="check-mark">✔</span><span>Basic Programming Knowledge</span></li>
            <li class="checklist-item"><span class="check-mark">✔</span><span>Problem Solving</span></li>
            <li class="checklist-item"><span class="check-mark">✔</span><span>Communication Skills</span></li>
            <li class="checklist-item"><span class="check-mark">✔</span><span>Passion to Learn</span></li>
          </ul>
        </div>
      </section>
      ...
      <section class="section">
        <div class="container">
          ${sectionHeader("Success Stories", "Intern Success Stories That Inspire Growth", "")}
          <div class="testimonial-slider reveal">
            ${testimonials.map(testimonialSlide).join("")}
            <div class="slider-controls">
              <button class="slider-btn" onclick="internshipTestimonialNav(-1)" aria-label="Previous testimonial">&#8592;</button>
              <div class="slider-dots">
                ${testimonials.map((_, i) => testimonialDot(i)).join("")}
              </div>
              <button class="slider-btn" onclick="internshipTestimonialNav(1)" aria-label="Next testimonial">&#8594;</button>
            </div>
          </div>
        </div>
      </section>
  ...
  `;
    ...
    setTimeout(() => {
      animateCounter("internCounter", 200, "+");
      animateCounter("placementCounter", 90, "%");
      animateCounter("weekCounter", 4);
    }, 0);
    ...
    function renderTestimonialSlide() {
      document.querySelectorAll(".testimonial-slide").forEach((el) => {
        el.classList.toggle(
          "is-active",
          Number(el.dataset.slide) === currentTestimonial
        );
      });
      document.querySelectorAll(".slider-dot").forEach((el) => {
        el.classList.toggle(
          "is-active",
          Number(el.dataset.dot) === currentTestimonial
        );
      });
    }

    window.internshipTestimonialNav = function (direction) {
      currentTestimonial =
        (currentTestimonial + direction + totalTestimonials) %
        totalTestimonials;
      renderTestimonialSlide();
    };

    window.internshipTestimonialGoTo = function (index) {
  ...
  function jobsPage() {
    app.innerHTML =
      ...
      jobCard(
        "🐍",
        "Python Developer",
        "Strong Python Developer with expertise in Django and Flask frameworks, REST API development, and front-end technologies including HTML, CSS, and JavaScript.",
        ["Python", "Django", "Flask"],
        "Remote",
        "Full-time"
      ) +
      jobCard(
        "🔷",
        ".NET Developer",
        "Proficient in C#, ASP.NET, and .NET Core with hands-on experience in SQL Server, Entity Framework, RESTful API development, dependency injection, unit testing, and Git version control.",
        ["C#", "ASP.NET", "SQL"],
        "Remote",
        "Full-time"
      ) +
      jobCard(
        "📈",
        "Marketing Executive",
        "Strong marketing professional with excellent verbal and written communication skills, digital marketing expertise, and exceptional organizational abilities for campaign management and brand growth.",
      ...
      '<section class="section"><div class="container">' +
      sectionHeader(
        "Why Join iLogic Tech",
        "Perks & Culture That Support Your Growth",
        ""
      ) +
      '<div class="grid-3 reveal">' +
      '<article class="glass card"><span class="perk-icon">🚀</span><h3>Growth Opportunities</h3><p class="muted">Clear career paths with regular reviews, promotions, and skill-building support.</p></article>' +
      '<article class="glass card"><span class="perk-icon">🌐</span><h3>Flexible Work</h3><p class="muted">Remote and hybrid options designed around how you do your best work.</p></article>' +
      '<article class="glass card"><span class="perk-icon">💡</span><h3>Innovative Projects</h3><p class="muted">Work on real products using modern tools and technologies from day one.</p></article>' +
      '<article class="glass card"><span class="perk-icon">🤗</span><h3>Inclusive Culture</h3><p class="muted">A collaborative, respectful team environment where every voice is heard.</p></article>' +
      '<article class="glass card"><span class="perk-icon">🏆</span><h3>Recognition & Rewards</h3><p class="muted">Performance-based rewards that celebrate your contributions.</p></article>' +
      '<article class="glass card"><span class="perk-icon">📚</span><h3>Continuous Learning</h3><p class="muted">Access to training, certifications, and mentorship to keep you growing.</p></article>' +
      "</div></div></section>" +
      '<section class="section section-muted"><div class="container">' +
      sectionHeader(
        "Application Process",
      ...
      processStep(
        ...
        "1",
        "Submit Application",
        "Send us your resume, portfolio, and cover letter through our online application system."
      ) +
      processStep(
        "🔍",
        "2",
        "Initial Review",
        "Our HR team reviews your application and assesses your qualifications and experience."
      ) +
      processStep(
        "☎️",
        "3",
        "Phone Screening",
        "Brief phone interview to discuss your background, interests, and role expectations."
      ) +
      processStep(
        "💻",
        "4",
        "Technical Assessment",
        "Complete a technical challenge or coding assessment relevant to the position."
      ) +
      processStep(
        "🤝",
        "5",
        "Team Interview",
        "Meet with team members and hiring managers to discuss your fit and potential contributions."
      ) +
      processStep(
        "🎉",
        "6",
        "Offer & Onboarding",
        "Receive your offer and begin the onboarding process to join our amazing team."
      ) +
      "</div></div></section>" +
      "</main>" +
      footer() +
  ...
  // ---------- helpers (declared after jobsPage, hoisted so they're usable above) ----------

  function jobCard(icon, title, desc, tags, location, type) {
    return (
      '<article class="glass card job-card"><div class="job-card-icon">' +
      icon +
      "</div><h3>" +
      title +
      '</h3><p class="muted job-card-desc">' +
      desc +
      '</p><div class="tag-list job-card-tags">' +
      tags
        .map(function (t) {
          return "<span>" + t + "</span>";
        })
        .join("") +
      '</div><div class="job-card-meta"><span>📍 ' +
      location +
      "</span><span>🕒 " +
      type +
      '</span></div><a class="btn btn-secondary job-card-btn" href="index.html#contact">Apply Now</a></article>'
    );
  }

  function processStep(icon, number, title, desc) {
    return (
      '<article class="glass card process-step"><div class="step-badge">' +
      number +
      '</div><span class="process-icon">' +
      icon +
      "</span><h3>" +
      title +
      '</h3><p class="muted">' +
  ...
  function jobsPageStyles() {
    return (
      '<style id="jobs-page-styles">' +
      ".jobs-hero-stats{display:flex;justify-content:center;gap:2rem;flex-wrap:wrap;margin-top:1.75rem;}" +
      ".jobs-hero-stat{display:flex;align-items:center;gap:0.5rem;font-size:0.9rem;color:var(--text-muted);}" +
      ".jobs-hero-stat-icon{font-size:1.1rem;}" +
      ".job-card{display:flex;flex-direction:column;height:100%;}" +
      ".job-card-icon{font-size:2rem;margin-bottom:0.5rem;}" +
      ".job-card-desc{margin-bottom:0.75rem;}" +
      ".job-card-tags{margin-bottom:1rem;}" +
      ".job-card-meta{display:flex;gap:1rem;flex-wrap:wrap;font-size:0.85rem;color:var(--text-muted);margin-bottom:1.5rem;}" +
      ".job-card-btn{align-self:flex-start;margin-top:auto;}" +
      ".perk-icon{font-size:1.9rem;display:block;margin-bottom:0.6rem;}" +
      ".process-step{position:relative;}" +
      ".process-icon{font-size:1.6rem;display:block;margin:0.5rem 0 0.5rem;}" +
      "</style>"
    );
  }
  ...
  function updateServiceMeta(slug) {
    var metaMap = {
      "mobile-apps": {
        title:
          "Mobile App Development Company in Madurai, Pondicherry & Singapore | iLogic Tech",
        ...
        schema: {
          ...
          description:
            "Custom iOS, Android, Flutter and React Native mobile app development for businesses across Madurai, Pondicherry, Tamil Nadu and Singapore.",
          areaServed: [
            "Madurai",
            "Pondicherry",
            "Coimbatore",
      ...
      "software-development": {
        title:
          "Software Development Company in Singapore & India | iLogic Tech",
      ...
      "web-applications": {
        title:
          "Web Application Development Company in Singapore & India | iLogic Tech",
      ...
      "ai-ml": {
        title:
          "AI & Machine Learning Solutions in Singapore & India | iLogic Tech",
      ...
      "cctv-surveillance": {
        title:
          "CCTV Surveillance & Security Solutions in Singapore & India | iLogic Tech",
    ...
    if (ogUrl)
      ogUrl.setAttribute(
        "content",
        "https://www.ilogic.com.sg/service.html?slug=" + slug
      );
    if (m.schema) {
  ...
  document
    .querySelectorAll(".mobile-nav a.mobile-link, .mobile-submenu a")
    .forEach((link) => {
      link.addEventListener("click", () => {
        ...
        document
          .querySelectorAll(".mobile-item.is-open")
          .forEach((item) => item.classList.remove("is-open"));
        document
          .querySelectorAll(
            '.mobile-item button.mobile-link[aria-expanded="true"]'
          )
          .forEach((button) => {
  ...
  const desktopNavItemsWithSubmenu = desktopNavItems.filter((item) =>
    ...
    desktopNavItemsWithSubmenu.forEach((item) => {
      ...
      item.addEventListener("mouseenter", () => {
        ...
        desktopNavItemsWithSubmenu.forEach((entry) => {
          if (!entry.classList.contains("is-pinned"))
  ...
  if (scrollTop) {
    const updateScrollTop = () =>
      scrollTop.classList.toggle("is-visible", window.scrollY > 450);
  ...
  const applyCountryDisplay = function (countryCode) {
    ...
    document.querySelectorAll("[data-nav-countries]").forEach((item) => {
      const countries = String(
        item.getAttribute("data-nav-countries") || "SG,IN"
      )
        .split(",")
        .map((code) => code.trim());
    ...
    document.querySelectorAll("[data-country-display]").forEach((section) => {
      const countries = String(
        section.getAttribute("data-country-display") || "SG,IN"
      )
        .split(",")
        .map((code) => code.trim());
  ...
  const countryButtons = Array.from(
    document.querySelectorAll("[data-country]")
  );
  if (countryButtons.length) {
    ...
    try {
      ...
      if (
        savedCountry &&
        countryOptions.some((option) => option.code === savedCountry)
      )
  ...
  const hiringRefresh = hiringChatbotEl
    ? hiringChatbotEl.querySelector("[data-hiring-refresh]")
    : null;
  ...
  if (
    ...
    const internshipKnowledge = {
      overview:
        "iLogic Tech offers an Internship Program for students and freshers who want industry-focused learning with hands-on project work.",
      tracks: internshipTracks
        .map((track) => track.title + ": " + track.summary)
        .join(" "),
      requirements:
        "Eligibility requirements are: " +
        internshipRequirements.join(", ") +
        ".",
      process:
        "The internship journey follows these steps: " +
        internshipJourney.join(" "),
      apply:
        "To apply, choose a role in the chat, complete the Quick Apply form, and submit it. The application is addressed to hr@ilogic.com.sg.",
    };
    const appendHiringMessage = function (role, html) {
      const item = document.createElement("div");
      item.className =
        "hiring-message " + (role === "user" ? "is-user" : "is-bot");
    ...
    const examKnowledge = {
      overview:
        "We support exam-related enquiries for LanguageCert, academic partner certifications, and global certification programs.",
      guidance:
        "Tell us the exam or certification you need help with and we will guide you through registration, scheduling, and enquiry submission.",
      apply:
        "To submit an exam-related application, choose your exam type below and send your details in the chat or use the email link.",
    ...
    const answerInternshipQuestion = function (question) {
      ...
      const matchedTrack = internshipTracks.find((track) =>
        track.keywords.some((keyword) => normalized.includes(keyword))
      );
      if (
        ...
        return (
          "<strong>Exam Enquiry</strong><br>" +
          examKnowledge.overview +
          "<br><br>" +
          examKnowledge.guidance +
          '<br><br><a class="btn btn-secondary" href="' +
          examKnowledge.email("Exam Enquiry") +
          '" target="_blank" rel="noreferrer noopener">Email Exam Enquiry</a>'
        );
      }
      if (
        (normalized.includes("apply") && normalized.includes("exam")) ||
        normalized.includes("apply for an exam")
      ) {
        return (
          "<strong>Exam Application</strong><br>" +
          examKnowledge.apply +
          '<br><br><a class="btn btn-secondary" href="' +
          examKnowledge.email("Exam Application") +
          '" target="_blank" rel="noreferrer noopener">Start Exam Application</a>'
        );
      }
      if (
      ...
      if (matchedTrack) {
        return (
          ...
          matchedTrack.title +
          "</strong><br>" +
          matchedTrack.summary +
          "<br>If you want this role, click Apply and choose <strong>" +
          matchedTrack.title +
          "</strong>."
        );
      }
      ...
      if (
        ...
        return (
          internshipKnowledge.overview +
          "<br><br><strong>Available tracks:</strong><br>" +
          internshipTracks
            .map((track) => "• " + track.title + " - " + track.summary)
            .join("<br>")
        );
      ...
      return (
        "I can help with internship tracks, eligibility, process, and applications.<br><br><strong>Available tracks:</strong><br>" +
        internshipTracks.map((track) => "• " + track.title).join("<br>")
      );
    };
    const resetHiringChat = function () {
      ...
      hiringRoleSelector
        .querySelectorAll("[data-hiring-role]")
      ...
      hiringRoleSelector
        ...
        .forEach((button) => {
          button.classList.toggle(
            "is-active",
            button.getAttribute("data-hiring-role") === role
          );
        });
      hiringApplyPanel.hidden = false;
    ...
    hiringChatbotEl
      .querySelectorAll("[data-hiring-close]")
      .forEach((control) => {
        control.addEventListener("click", closeHiringChat);
      });
    hiringChatbotEl
      .querySelectorAll("[data-hiring-question]")
      .forEach((button) => {
        button.addEventListener("click", function () {
    ...
    hiringChatbotEl
      .querySelectorAll("[data-hiring-apply-open]")
      .forEach((button) => {
        button.addEventListener("click", function () {
    ...
    hiringChatbotEl
      .querySelectorAll("[data-hiring-apply-close]")
      .forEach((button) => {
        button.addEventListener("click", function () {
          hiringApplyPanel.hidden = true;
          hideHiringQuickActions();
    ...
    hiringApplyForm.addEventListener("submit", function (event) {
      ...
      appendHiringMessage(
        "user",
        "I have completed my application for " + role + "."
      );
      appendHiringMessage(
        "bot",
        "Your application is ready to send to <strong>hr@ilogic.com.sg</strong>. We have opened your email app with the completed details."
      );
      window.location.href =
        "mailto:hr@ilogic.com.sg?subject=" +
        encodeURIComponent("Internship Application - " + role) +
        "&body=" +
        encodeURIComponent(body);
    ...
    document.addEventListener("keydown", function (event) {
      if (
        event.key === "Escape" &&
        hiringChatbotEl.classList.contains("is-open")
      ) {
        closeHiringChat();
      }
    });
  ...
  const solutionStatEls = Array.from(
    document.querySelectorAll("[data-solution-stat]")
  );
  ...
  if (solutionPlayerEl && solutionVideo) {
    ...
    const toggleButtons = Array.from(
      solutionPlayerEl.querySelectorAll("[data-video-toggle]")
    );
    const progressInput = solutionPlayerEl.querySelector(
      "[data-video-progress]"
    );
    ...
    const captionButton = solutionPlayerEl.querySelector(
      "[data-video-captions]"
    );
    const minimizeButton = solutionPlayerEl.querySelector(
      "[data-video-minimize]"
    );
    const floatButton = solutionPlayerEl.querySelector("[data-video-float]");
    const fullscreenButton = solutionPlayerEl.querySelector(
      "[data-video-fullscreen]"
    );
    const dragHandle = solutionPlayerEl.querySelector(
    ...
    const updateCaptions = function () {
      ...
      const index = Math.min(
        detail.video.cues.length - 1,
        Math.floor(solutionVideo.currentTime / segment)
      );
    ...
    const updateProgress = function () {
      if (progressInput) {
        const percent = solutionVideo.duration
          ? (solutionVideo.currentTime / solutionVideo.duration) * 100
          : 0;
        progressInput.value = String(percent);
      }
      if (timeEl)
        timeEl.textContent =
          formatTime(solutionVideo.currentTime) +
          " / " +
          formatTime(solutionVideo.duration);
      setToggleLabels();
      updateCaptions();
    };
    ...
    if (progressInput) {
      progressInput.addEventListener("input", function () {
        ...
        solutionVideo.currentTime =
          (Number(progressInput.value) / 100) * solutionVideo.duration;
        updateProgress();
      });
    }
    if (volumeInput) {
    ...
    if (dragHandle) {
      ...
      dragHandle.addEventListener("pointermove", function (event) {
        if (!dragState || !solutionPlayerEl.classList.contains("is-floating"))
          return;
        const nextLeft =
          dragState.rect.left + (event.clientX - dragState.startX);
        const nextTop = dragState.rect.top + (event.clientY - dragState.startY);
        solutionPlayerEl.style.left =
          Math.max(
            8,
            Math.min(window.innerWidth - dragState.rect.width - 8, nextLeft)
          ) + "px";
        solutionPlayerEl.style.top =
          Math.max(
            8,
            Math.min(window.innerHeight - dragState.rect.height - 8, nextTop)
          ) + "px";
      });
  ...
  const feedbackStars = Array.from(
    document.querySelectorAll("[data-feedback-rating]")
  );
    ...
    link.addEventListener("click", function (event) {
      ...
      if (!savedName) {
        const enteredName = window.prompt(
          "Enter your name for the WhatsApp message:",
          ""
        );
      ...
      window.open(
        buildWhatsAppUrl(phone, savedName),
        "_blank",
        "noopener,noreferrer"
      );
    });
  ...
  if (
    ...
    const containsBlockedLanguage = function (post) {
      ...
      return blockedFeedbackPatterns.some((pattern) =>
    ...
    const renderTestimonials = function () {
      ...
      testimonialsGrid.innerHTML = getAllTestimonials()
        .map(testimonialCardMarkup)
        .join("");
    };
    const showTestimonialsSection = function () {
      if (testimonialsGrid) {
        ...
        if (
          testimonialsSection &&
          typeof testimonialsSection.scrollIntoView === "function"
        ) {
    ...
    const updatePostButtonState = function () {
      ...
      const isComplete = Boolean(
        post.name && post.company && post.role && post.rating && post.message
      );
      ...
      if (feedbackPostButton)
        feedbackPostButton.disabled = !isComplete || hasBlockedLanguage;
    };
    ...
    document.addEventListener("keydown", function (event) {
      if (
        event.key === "Escape" &&
        feedbackModalEl.classList.contains("is-open")
      ) {
        closeFeedbackModal();
      }
    });
  ...
  Array.from(document.querySelectorAll("[data-exam-toggle-form]")).forEach(
    function (button) {
      button.addEventListener("click", function () {
  ...
  Array.from(document.querySelectorAll("[data-enquiry-form]")).forEach(
    function (form) {
      form.addEventListener("submit", function (event) {
        event.preventDefault();
        ...
        if (followConfirm && !followConfirm.checked) {
          showExamToast(
            "&#9888;&#65039; Please follow our social media and confirm before submitting."
          );
          followConfirm.focus();
          return;
        }
        ...
        if (examTypeInput)
          examTypeInput.value = form.getAttribute("data-exam-type") || "";
  ...
  const examFeedbackStars = Array.from(
    document.querySelectorAll("[data-exam-feedback-rating]")
  );
  if (
    examFeedbackForm &&
    examFeedbackRating &&
    ...
    const setExamFeedbackRating = function (value) {
      ...
      examFeedbackStars.forEach(function (star) {
        const starValue = Number(
          star.getAttribute("data-exam-feedback-rating")
        );
    ...
    examFeedbackStars.forEach(function (star) {
      star.addEventListener("click", function () {
        setExamFeedbackRating(
          Number(star.getAttribute("data-exam-feedback-rating") || "0")
        );
      });
    });
    ...
    examFeedbackForm.addEventListener("submit", function (event) {
      ...
      if (
        ...
        !Number(examFeedbackRating.value || "0") ||
        !examFollowConfirm.checked
      )
        return;
  ...
  const galleryMap = Object.fromEntries(
    galleryCollections.map((item) => [item.key, item])
  );
  ...
  const galleryActionCommentCount = document.getElementById(
    "galleryActionCommentCount"
  );
  ...
  const galleryShareToggle = document.querySelector(
    "[data-gallery-toggle-share]"
  );
  const galleryDownloadAction = document.getElementById(
    "galleryDownloadAction"
  );
  ...
  if (
    ...
    const loadGalleryState = function () {
      try {
        const stored = JSON.parse(
          window.localStorage.getItem(galleryStorageKey) || "{}"
        );
        if (stored && typeof stored === "object") {
          galleryState.likes =
            stored.likes && typeof stored.likes === "object"
              ? stored.likes
              : {};
          galleryState.interactions =
            stored.interactions && typeof stored.interactions === "object"
              ? stored.interactions
              : {};
          galleryState.comments =
            stored.comments && typeof stored.comments === "object"
              ? stored.comments
              : {};
        }
      } catch (error) {}
    ...
    const ensureCollectionState = function (collectionKey) {
      if (!(collectionKey in galleryState.likes))
        galleryState.likes[collectionKey] = false;
      const defaultCounts = {
        like: 0,
        whatsapp: 0,
        facebook: 0,
      ...
      galleryState.interactions[collectionKey] = Object.assign(
        {},
        defaultCounts,
        galleryState.interactions[collectionKey] || {}
      );
    ...
    const incrementInteraction = function (collectionKey, type) {
      ...
      if (!(type in galleryState.interactions[collectionKey]))
        galleryState.interactions[collectionKey][type] = 0;
    ...
    const buildShareLinks = function (collection) {
      const shareUrl = encodeURIComponent(
        window.location.href.split("#")[0] + "#gallery"
      );
      ...
      if (galleryDownloadAction) {
        galleryDownloadAction.href =
          collection.images[galleryState.activeIndex];
        galleryDownloadAction.setAttribute(
          "download",
    ...
    const renderInteractionCounts = function () {
      ...
      Object.keys(galleryInteractionCountEls).forEach(function (name) {
        if (galleryInteractionCountEls[name]) {
          galleryInteractionCountEls[name].textContent = String(
            counts[name] || 0
          );
    ...
    const renderComments = function () {
      const activeComments =
        galleryState.comments[galleryState.activeKey] || [];
      galleryCommentCount.textContent =
      ...
      galleryCommentList.innerHTML = activeComments.length
        ? activeComments
            .map(
              (comment) =>
                '<div class="gallery-comment-item"><strong>' +
    ...
    const renderGalleryModal = function () {
      ...
      galleryModalImage.alt =
        collection.title + " image " + (galleryState.activeIndex + 1);
      ...
      galleryModalIndex.textContent =
        galleryState.activeIndex + 1 + " / " + collection.images.length;
      galleryLikeButton.classList.toggle(
        "is-active",
        Boolean(galleryState.likes[galleryState.activeKey])
      );
      galleryLikeButton.setAttribute(
        "aria-pressed",
        String(Boolean(galleryState.likes[galleryState.activeKey]))
      );
      galleryLikeLabel.textContent = galleryState.likes[galleryState.activeKey]
        ? "Liked"
        : "Like";
    ...
    const stepGalleryModal = function (direction) {
      ...
      galleryState.activeIndex =
        (galleryState.activeIndex + direction + collection.images.length) %
    ...
    if (galleryPrev)
      galleryPrev.addEventListener("click", () => stepGalleryModal(-1));
    if (galleryNext)
      galleryNext.addEventListener("click", () => stepGalleryModal(1));
    galleryLikeButton.addEventListener("click", function () {
      const key = galleryState.activeKey;
      if (!key) return;
      ensureCollectionState(key);
      galleryState.likes[key] = !galleryState.likes[key];
      galleryState.interactions[key].like = Math.max(
        0,
        Number(galleryState.interactions[key].like || 0) +
          (galleryState.likes[key] ? 1 : -1)
      );
      saveGalleryState();
      renderGalleryModal();
    });
    ...
    const commentFocusButton = document.querySelector(
      "[data-gallery-focus-comment]"
    );
    if (commentFocusButton) {
      commentFocusButton.addEventListener("click", function () {
        if (galleryCommentName && !galleryCommentName.value.trim())
          galleryCommentName.focus();
