(function() {
  ...
  const partnerProfiles = [{
    name: "CELPIP",
    logo: celpipPartnerLogo,
    href: "https://www.celpip.ca/",
    url: "https://www.celpip.ca/",
    description: "Canadian English certification partner for global test preparation and assessment."
  }, {
    name: "LanguageCert",
    logo: languageCertLogo,
    href: "https://www.languagecert.org/",
    url: "https://www.languagecert.org/",
    description: "Official LanguageCert partner offering international English certification services."
  }, {
    name: "BeingCert",
    logo: academicPartnerLogo,
    href: "https://www.beingcert.com/",
    url: "https://www.beingcert.com/",
    description: "Academic certification partner focused on education and skill validation."
  }, {
    name: "Global Certification",
    logo: globalCertificateLogo,
    href: "https://www.globalcertification.org/",
    url: "https://www.globalcertification.org/",
    description: "Certification partner supporting international credentialing and compliance."
  }, {
    name: "Retail Tech",
    logo: "src/assets/partners/partner-3.webp",
    href: "#",
    url: "#",
    description: "Technology partner enabling retail transformation with POS and analytics."
  }, {
    name: "Enterprise Systems",
    logo: "src/assets/partners/partner-4.webp",
    href: "#",
    url: "#",
    description: "Enterprise partner delivering secure infrastructure and operations solutions."
  }];
  const clientPortfolio = [{
    logo: clientLogos[0],
    name: "Retail Market Hub",
    category: "Retail",
    description: "Smart checkout and inventory platform for multi-store retail operations."
  }, {
    logo: clientLogos[1],
    name: "Hospitality Connect",
    category: "Hospitality",
    description: "Guest service automation and POS integration for dining and lodging."
  }, {
    logo: clientLogos[2],
    name: "Campus Learn",
    category: "Education",
    description: "Certification and training delivery for academic and professional learning."
  }, {
    logo: clientLogos[3],
    name: "Logistics Edge",
    category: "Logistics",
    description: "Warehouse workflow optimisation with digital tracking and reporting."
  }, {
    logo: clientLogos[4],
    name: "Healthcare Pulse",
    category: "Healthcare",
    description: "Secure operations management for clinics, pharmacies, and wellness centres."
  }, {
    logo: clientLogos[5],
    name: "Training Works",
    category: "Certification",
    description: "Assessment and credential support for learners and professionals."
  }, {
    logo: clientLogos[6],
    name: "Retail Precision",
    category: "Retail",
    description: "In-store analytics and transaction automation for modern retail teams."
  }, {
    logo: clientLogos[7],
    name: "Academy Bridge",
    category: "Education",
    description: "Exam preparation support and campus-level certification services."
  }];
  const caseStudies = [{
    title: "POS Modernization for Retail Chain",
    industry: "Retail",
    challenge: "Fragmented store operations and manual checkout workflows.",
    solution: "Deployed a unified POS platform with inventory automation and mobile reporting.",
    result: "Reduced transaction time by 40% and improved stock accuracy across stores."
  }, {
    title: "Certification Delivery Transformation",
    industry: "Education",
    challenge: "Students needed streamlined exam registration and readiness tracking.",
    solution: "Integrated certification support with training workflows and secure scheduling.",
    result: "Increased candidate readiness and accelerated exam completion rates."
  }, {
    title: "Hospitality Operations Upgrade",
    industry: "Hospitality",
    challenge: "Service teams lacked real-time order visibility and guest insights.",
    solution: "Built a POS and operations dashboard with customer engagement analytics.",
    result: "Improved service speed and guest satisfaction through data-driven operations."
  }];
  const team = [{
    role: "Founder",
  ...
  function topContactBar() {
    const instagramLink = socialPlatforms.find(item => item[0] === "instagram");
    const instagramHref = instagramLink ? instagramLink[1] : (socialPlatforms[0] ? socialPlatforms[0][1] : "#");
    const primaryPhone = enquiryNumbers[0] ? enquiryNumbers[0].whatsapp : "";
    return '<div class="header-topbar"><div class="container"><div class="header-topbar-inner"><div class="topbar-brand"><img src="iLogo_logo.webp" alt="iLogic Tech" class="topbar-logo" /></div><div class="topbar-quote-wrap"><p class="topbar-quote" aria-live="polite"><span class="topbar-quote-text">' + topbarInfoMessages[0] + '</span></p></div><div class="topbar-actions"><a class="topbar-button topbar-button-contact" href="' + buildWhatsAppUrl(primaryPhone, "") + '" data-whatsapp-link data-phone="' + primaryPhone + '" aria-label="Contact us on WhatsApp"><span class="topbar-button-icon">' + topbarWhatsAppIcon() + '</span><span>Contact Us</span></a><a class="topbar-button topbar-button-follow" href="' + instagramHref + '" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram"><span class="topbar-button-icon">' + socialIcon("instagram") + '</span><span>Follow Us</span></a></div></div></div></div>';
  }

  function initTopbarQuoteTicker() {
    const quoteEl = document.querySelector(".topbar-quote-text");
    if (!quoteEl || !topbarInfoMessages.length) return;
    let index = 0;
    const rotateQuote = function() {
      quoteEl.classList.add("is-fading");
      window.setTimeout(function() {
        index = (index + 1) % topbarInfoMessages.length;
        quoteEl.textContent = topbarInfoMessages[index];
        quoteEl.classList.remove("is-fading");
      }, 420);
    };
    window.setInterval(rotateQuote, 4000);
  }
  ...
  function whatsappFloat() {
    const phone = enquiryNumbers[0] ? enquiryNumbers[0].whatsapp : "";
    if (!phone) return "";
    return '<a class="whatsapp-float" href="' + buildWhatsAppUrl(phone, "") + '" data-whatsapp-link data-phone="' + phone + '" target="_blank" rel="noopener noreferrer" aria-label="Contact us on WhatsApp"><span class="whatsapp-float-ring" aria-hidden="true"></span><span class="whatsapp-float-icon" aria-hidden="true">' + topbarWhatsAppIcon() + '</span></a>';
  }
  ...
  function testimonialCardMarkup(item) {
    return '<article class="glass card testimonial-card reveal is-visible">' +
      '<div class="review-header"><div class="avatar-badge">' + avatarInitials(item.name) + '</div><div class="review-meta"><h3>' + escapeHtml(item.name) + '</h3><p class="muted">' + escapeHtml(item.company) + ' | ' + escapeHtml(item.role) + '</p></div></div>' +
      '<p class="stars">' + Array((item.rating || 0) + 1).join("★") + '</p><p class="muted review-message">' + escapeHtml(item.message) + '</p></article>';
  }
 ...
 function solutionVideoPlayer(item, detail) {
  ...
  function portfolioStats() {
    const stats = [
      { icon: '<svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path d="M10 2a8 8 0 108 8 8.009 8.009 0 00-8-8zm0 1.5a6.5 6.5 0 015.995 4.68 7.96 7.96 0 01-3.64-1.24A8.094 8.094 0 0010 3.5zM4.5 10a5.505 5.505 0 013.92-5.29 7.513 7.513 0 00.06 7.54A5.503 5.503 0 014.5 10zm6.24 5.39a7.524 7.524 0 003.02-2.24 5.507 5.507 0 01-3.02 2.24zM10 16.5a6.498 6.498 0 01-5.22-2.69 7.93 7.93 0 003.27-1.2 8.027 8.027 0 002.06 3.89z"/></svg>', value: 4, suffix: "+", label: "Countries supported", decimals: 0 },
      { icon: '<svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path d="M6 4.5A1.5 1.5 0 007.5 3h5A1.5 1.5 0 0014 4.5V5h1.5A1.5 1.5 0 0017 6.5v8A1.5 1.5 0 0015.5 16H4.5A1.5 1.5 0 003 14.5v-8A1.5 1.5 0 004.5 5H6v-.5zM7.5 4a.5.5 0 00-.5.5V5h6v-.5a.5.5 0 00-.5-.5h-5zM4.5 6a.5.5 0 00-.5.5v.5h12v-.5a.5.5 0 00-.5-.5h-11zM4 8.5v5a.5.5 0 00.5.5h11a.5.5 0 00.5-.5v-5H4z"/></svg>', value: 300, suffix: "+", label: "Businesses onboarded", decimals: 0 },
      { icon: '<svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path d="M10 2a1 1 0 011 1v2.04a6 6 0 015 5.96 1 1 0 11-2 0 4 4 0 00-4-4 1 1 0 00-.84.48L8.15 9H6a1 1 0 000 2h2l1.17 2.34a1 1 0 00.9.66H13a1 1 0 100-2h-1.42L10.83 9.66A1 1 0 0010 9a2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4V3a1 1 0 00-1-1z"/></svg>', value: 12000, suffix: "+", label: "Transactions processed daily", decimals: 0 },
      { icon: '<svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M10 2a1 1 0 00-.894.553L7.382 5.94 4.2 6.293A1 1 0 003 7.26v4.99a6 6 0 0011.736 1.77l1.053-3.344a1 1 0 00-.702-1.288l-3.37-.802L11.894 2.553A1 1 0 0010 2zm0 2.17L11.21 7h3.14l-2.54.6L11.3 11H8.7l-.7-3.4L5.72 7h3.14L10 4.17z" clip-rule="evenodd"/></svg>', value: 99.9, suffix: "%", label: "Platform uptime", decimals: 1 }
    ];
    return '<div class="portfolio-stats-grid reveal">' + stats.map(item => '<article class="glass stat-card"><strong><span class="counter-icon">' + item.icon + '</span><span class="counter" data-target="' + item.value + '" data-decimals="' + item.decimals + '">0</span><span class="counter-suffix">' + item.suffix + '</span></strong><span>' + item.label + '</span></article>').join('') + '</div>';
  }
  ...
  function heroStats() {
    ...
    return '<div class="hero-stats-grid reveal">' + stats.map(item => '<article class="glass stat-card hero-stat-card"><strong><span class="counter" data-target="' + item.value + '" data-decimals="0">0</span><span class="counter-suffix">' + item.suffix + '</span></strong><span>' + item.label + '</span></article>').join('') + '</div>';
  }

  function strategicPartnersSection(partnersList) {
    const featured = partnersList.filter(item => ["LanguageCert", "CELPIP", "BeingCert"].includes(item.name)).slice(0, 3);
    return '<section class="section strategic-partners-section" id="strategic-partners"><div class="container"><div class="section-heading reveal"><span class="eyebrow"><span class="eyebrow-dot"></span>Our Strategic Partners</span><h2>Our Strategic Partners</h2><p class="lead">Trusted global technology partners helping us deliver enterprise-grade solutions.</p></div><div class="partner-cards-grid reveal">' + featured.map(item => '<a class="partner-highlight-card glass" href="' + item.url + '" target="_blank" rel="noopener noreferrer"><div class="partner-logo-wrap"><img src="' + item.logo + '" alt="' + item.name + ' logo" loading="lazy" /></div><strong>' + item.name + '</strong><p>' + item.description + '</p></a>').join('') + '</div></div></section>';
  }

  function clientLogoCarousel(items) {
    const logos = items.map(item => '<div class="logo-carousel-item"><img src="' + item.logo + '" alt="' + item.name + ' logo" loading="lazy" /></div>').join("");
    return '<section class="section section-muted" id="client-carousel"><div class="container">' + sectionHeader("Trusted Clients", "Client Logo Gallery", "A curated showcase of the client brands we support.") + '<div class="logo-carousel reveal"><div class="logo-carousel-track">' + logos + '</div></div></div></section>';
  }

  function partnerShowcase(partnersList) {
    return '<div class="partner-showcase reveal"><div class="partner-showcase-grid">' + partnersList.map(item => '<a class="partner-brand-card glass" href="' + item.url + '" target="_blank" rel="noopener noreferrer"><img src="' + item.logo + '" alt="' + item.name + ' logo" loading="lazy" /><div><strong>' + item.name + '</strong><p class="muted">' + item.description + '</p></div></a>').join('') + '</div></div>';
  }

  function clientShowcase(items) {
    return '<div class="client-showcase-grid reveal">' + items.map(item => '<article class="glass client-card"><div class="client-logo"><img src="' + item.logo + '" alt="' + item.name + ' logo" loading="lazy" /></div><div><h3>' + item.name + '</h3><p class="muted">' + item.category + '</p><p>' + item.description + '</p></div></article>').join('') + '</div>';
  }

  function caseStudyCarousel(items) {
    return '<div class="case-study-carousel reveal"><div class="case-study-track">' + items.map(item => '<article class="glass case-study-card"><h3>' + item.title + '</h3><p class="muted">' + item.industry + '</p><p>' + item.challenge + '</p><div class="case-study-result"><strong>Result</strong><p>' + item.result + '</p></div></article>').join('') + '</div></div>';
  }

  function homePage() {
    const homeMarkup = header(true) +
      '<main>' +
      '<section class="hero hero-portfolio portfolio-landing" id="home" data-country-display="SG">' +
      '<div class="container hero-carousel-shell reveal">' +
      '<div class="hero-carousel">' +
      '<div class="hero-carousel-stage">' +
      '<article class="hero-slide is-active" data-hero-slide>' +
      '<div class="hero-slide-content">' +
      '<span class="eyebrow"><span class="eyebrow-dot"></span>OUR PORTFOLIO</span>' +
      '<h1>Delivering Excellence Through <span class="gradient-text">Strategic Partnerships</span></h1>' +
      '<p class="lead">Showcase iLogic Technology&apos;s successful collaborations, trusted global partners, client success stories, product installations, and technology solutions that drive business transformation.</p>' +
      '<div class="hero-slide-actions"><a class="btn btn-primary" href="#clients">Explore Portfolio</a><a class="btn btn-secondary" href="#contact">Contact Us</a></div>' +
      '</div>' +
      '<div class="hero-slide-media"><div class="hero-slide-media-card glass"><img src="src/assets/products/pos-terminal.jpg" alt="POS product" loading="eager" /></div></div>' +
      '</article>' +
      '<article class="hero-slide" data-hero-slide>' +
      '<div class="hero-slide-content">' +
      '<span class="eyebrow"><span class="eyebrow-dot"></span>ENTERPRISE RETAIL</span>' +
      '<h1>Fast Checkout, Accurate Inventory, <span class="gradient-text">Smarter Stores</span></h1>' +
      '<p class="lead">Deliver premium retail experiences with connected POS systems, barcode scanning, receipt automation, and real-time reporting for every location.</p>' +
      '<div class="hero-slide-actions"><a class="btn btn-primary" href="#clients">Explore Portfolio</a><a class="btn btn-secondary" href="#contact">Contact Us</a></div>' +
      '</div>' +
      '<div class="hero-slide-media"><div class="hero-slide-media-card glass"><img src="src/assets/products/barcode-scanner.jpg" alt="Barcode scanner" loading="eager" /></div></div>' +
      '</article>' +
      '<article class="hero-slide" data-hero-slide>' +
      '<div class="hero-slide-content">' +
      '<span class="eyebrow"><span class="eyebrow-dot"></span>PREMIUM DEPLOYMENTS</span>' +
      '<h1>Modern Product Installations with <span class="gradient-text">Reliable Support</span></h1>' +
      '<p class="lead">Showcase global partner-enabled deployments with secure POS rollouts, receipt printing, cash management, and enterprise-grade hardware support.</p>' +
      '<div class="hero-slide-actions"><a class="btn btn-primary" href="#clients">Explore Portfolio</a><a class="btn btn-secondary" href="#contact">Contact Us</a></div>' +
      '</div>' +
      '<div class="hero-slide-media"><div class="hero-slide-media-card glass"><img src="src/assets/products/printer.jpg" alt="Receipt printer" loading="eager" /></div></div>' +
      '</article>' +
      '</div>' +
      '<button class="hero-carousel-control hero-carousel-prev" aria-label="Previous slide">‹</button>' +
      '<button class="hero-carousel-control hero-carousel-next" aria-label="Next slide">›</button>' +
      '<div class="hero-carousel-dots">' +
      '<button class="hero-carousel-dot is-active" type="button"></button>' +
      '<button class="hero-carousel-dot" type="button"></button>' +
      '<button class="hero-carousel-dot" type="button"></button>' +
      '</div>' +
      '</div>' +
      '</div>' +
      '</section>' +
      strategicPartnersSection(partnerProfiles) +
      clientLogoCarousel(clientPortfolio) +
      '<section class="section section-muted" id="gallery"><div class="container">' + sectionHeader("Gallery", "Selected Deployments & Exam Center Highlights", "Featured gallery visuals from our client rollouts, partner spaces, and certification services.") + '<div class="gallery-grid reveal">' + clientPortfolio.map(item => '<article class="glass card"><div class="client-logo"><img src="' + item.logo + '" alt="' + item.name + ' logo" loading="lazy" /></div><h3>' + item.name + '</h3><p class="muted">' + item.category + '</p><p>' + item.description + '</p></article>').join('') + '</div></div></section>' +
      '<section class="section" id="reviews"><div class="container">' + sectionHeader("Reviews", "Customer Feedback & Success Stories", "Hear from clients and partners who trust iLogic Tech for enterprise systems, certifications, and support.") + '<div class="testimonials-grid" id="testimonialsGrid"></div></div></section>' +
      '<section class="section" id="clients" data-country-display="SG"><div class="container">' + sectionHeader("Portfolio", "Featured Client Deployments", "Explore selected projects that demonstrate our enterprise-ready capabilities.") + clientShowcase(clientPortfolio) + '</div></section>' +
      '<section class="section" id="about" data-country-display="SG"><div class="container">' + sectionHeader("About Us", "Trusted by Regional Leaders in Retail, Hospitality, and Education", "We build systems that reduce complexity, remove operational silos, and help leaders scale with confidence.") + '<div class="split-grid">' +
      '<div class="reveal"><h3 class="gradient-text">A hybrid portfolio of POS, certification, and IT services</h3><p class="lead">We combine retail technology with certification support and secure infrastructure, so businesses move from fragmented tooling to a unified digital operation.</p><ul class="portfolio-list">' + ['POS system deployment & support', 'Language certification partnership and exam handling', 'Secure networks, CCTV, and compliance-ready operations', 'Onboarding, training, and long-term support'].map(item => '<li>' + item + '</li>').join('') + '</ul></div>' +
      '<div class="reveal portfolio-highlight-grid">' +
      '<article class="glass card"><h3>Strategic Growth</h3><p class="muted">Embed technology that supports expansion, reporting, and new revenue channels.</p></article>' +
      '<article class="glass card"><h3>Operational Resilience</h3><p class="muted">Keep stores, centres, and training programs running reliably at scale.</p></article>' +
      '<article class="glass card"><h3>Certification Delivery</h3><p class="muted">Enable candidates with secure exam access and hands-on preparation support.</p></article>' +
      '<article class="glass card"><h3>Service Excellence</h3><p class="muted">Fast deployment, clear onboarding, and responsive support for every customer.</p></article>' +
      '</div>' +
      '</div></div></section>' +
      '<section class="section" id="case-studies"><div class="container">' + sectionHeader("Case Studies", "Selected Success Stories", "Real outcomes from technology deployments across retail, education, and hospitality.") + caseStudyCarousel(caseStudies) + '</div></section>' +
      '<section class="section section-muted" id="projects" data-country-display="SG"><div class="container">' + sectionHeader("Portfolio", "Featured Client Deployments", "Explore selected projects that demonstrate our enterprise-ready capabilities.") + clientShowcase(clientPortfolio) + '</div></section>' +
      '<section class="section" id="services" data-country-display="SG"><div class="container">' + sectionHeader("Our Services", "Comprehensive Services", "Technology solutions tailored to your industry needs.") + '<div class="grid-3">' + services.map(item => '<article class="glass card reveal service-card"><div class="icon-badge service-icon-badge">' + serviceIcon(item[0]) + '</div><h3>' + item[1] + '</h3><p class="muted">' + item[2] + '</p><ul class="service-points">' + item[3].map(feature => '<li>' + feature + '</li>').join('') + '</ul><a class="btn btn-secondary" href="' + serviceCardHref(item[0]) + '">View More Details</a></article>').join('') + '</div></div></section>' +
      '</main>' +
      footer() +
      whatsappFloat() +
      googleFeedbackFloat() +
  ...
  function refineHomeHero() {
    ...
    if (!hero) return;
    const heroHeading = hero.querySelector(".hero-slide-content h1");
    if (heroHeading) {
      heroHeading.innerHTML = "Integrated POS Systems & IT Solutions for Businesses in Singapore and India";
    }
  }
  ...
  function initHomeHeroCarousel() {
    ...
    const prev = hero.querySelector(".hero-carousel-prev");
    const next = hero.querySelector(".hero-carousel-next");
    const dots = hero.querySelector(".hero-carousel-dots");
    ...
    function updateCarousel(index) {
      ...
      dots.querySelectorAll(".hero-carousel-dot").forEach((dot, dotIndex) => {
    ...
    function startAutoplay() {
      ...
      autoplay = window.setInterval(() => updateCarousel(activeIndex + 1), 5000);
    }
  ...
  function initHomeCounters() {
    ...
    const animateCounter = function(counter) {
      ...
      const tick = function(now) {
        ...
        counter.textContent = decimals ? current.toFixed(decimals) : String(Math.floor(current));
  ...
  function initClientAndPartnerMarquees() {
    const clientTrack = document.querySelector('.logo-carousel-track');
    if (clientTrack) {
      const clone = clientTrack.innerHTML;
      clientTrack.innerHTML += clone;
    }
    const partnerGrid = document.querySelector('#partners .partner-showcase-grid');
    if (partnerGrid) {
      const clone = partnerGrid.innerHTML;
      partnerGrid.innerHTML += clone;
    }
  }
  ...
  function initTestimonialCarousel() {
    ...
    let autoplay = null;
    const showActive = function(index) {
    ...
    const startAutoplay = function() {
      clearInterval(autoplay);
      autoplay = window.setInterval(() => showActive(activeIndex + 1), intervalTime);
    };
    testimonialsGrid.addEventListener('mouseenter', () => clearInterval(autoplay));
  ...
  function initClickHighlight() {
    document.addEventListener('click', function(event) {
      const logoCard = event.target.closest('.logo-carousel-item, .partner-brand-card');
      if (!logoCard) return;
      logoCard.classList.add('is-clicked');
      setTimeout(() => {
        logoCard.classList.remove('is-clicked');
      }, 1000);
    });
  }
...
function projectsPage() {
    app.innerHTML = header(false) + '<main>' +
      '<section class="hero hero-portfolio portfolio-landing" id="portfolio">' +
      '<div class="container hero-portfolio-grid">' +
      '<div class="hero-portfolio-copy reveal">' +
      '<span class="eyebrow"><span class="eyebrow-dot"></span>OUR PORTFOLIO</span>' +
      '<h1>Delivering Excellence Through <span class="gradient-text">Strategic Partnerships</span></h1>' +
      '<p class="lead">Showcase iLogic Technology&apos;s successful collaborations, trusted global partners, client success stories, product installations, and technology solutions that drive business transformation.</p>' +
      '<div class="hero-portfolio-actions"><a class="btn btn-primary" href="#projects-list">Explore Portfolio</a><a class="btn btn-secondary" href="#contact">Contact Us</a></div>' +
      '</div>' +
      '<div class="hero-portfolio-media reveal">' +
      '<div class="hero-portfolio-media-shell">' +
      '<div class="hero-illustration-card hero-card-main glass"><div class="hero-card-label">iLogic POS Machine</div><img src="src/assets/products/pos-terminal.jpg" alt="iLogic POS Machine" loading="eager" /></div>' +
      '<div class="hero-illustration-card hero-card-scan glass"><div class="hero-card-label">Barcode Scanner</div><img src="src/assets/products/barcode-scanner.jpg" alt="Barcode Scanner" loading="eager" /></div>' +
      '<div class="hero-illustration-card hero-card-print glass"><div class="hero-card-label">Receipt Printer</div><img src="src/assets/products/printer.jpg" alt="Receipt Printer" loading="eager" /></div>' +
      '<div class="hero-illustration-card hero-card-cash glass"><div class="hero-card-label">Cash Drawer</div><img src="src/assets/products/cash-drawer.jpg" alt="Cash Drawer" loading="eager" /></div>' +
      '</div>' +
      '</div>' +
      '</div>' +
      '</section>' +
      strategicPartnersSection(partnerProfiles) +
      '<section class="section section-muted" id="projects-list"><div class="container">' +
      sectionHeader("Featured Portfolio", "Selected Deployments & Transformations", "Explore our portfolio of integrated POS, certification, and enterprise software implementations.") +
      clientShowcase(clientPortfolio) +
      '</div></section>' +
      '</main>' + footer() + whatsappFloat() + googleFeedbackFloat() + feedbackModal() + hiringWidget() + internshipChatbotModal();
}
  if (page === "home") {
